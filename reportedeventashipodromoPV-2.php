...
if (mysqli_num_rows($result) != 0) :
	...
	$result = mysqli_query($GLOBALS['link'], "SELECT _tjugadahi.*,_tconfjornadahi.IDhipo FROM _tjugadahi,_tconfjornadahi where _tjugadahi.IDCN=_tconfjornadahi.IDCN and  (anulado=0 or anulado=4 or anulado=3 )  " . $add . " order by _tconfjornadahi.IDhipo ,_tjugadahi.IDCN,IDJug,carr,serial");

	//echo("SELECT _tjugadahi.*  FROM _tjugadahi where   anulado=0  ".$add." order by IDCN,IDJug,carr,serial" );
