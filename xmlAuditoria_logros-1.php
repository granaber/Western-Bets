...
<div id="box4" style="background: #036">
	<div align="left" style="color:#FC0">Indique la Fecha:
		...
		Banca:<select name="select2" id="IDB">
			...
			?>
		</select><input name="" type="button" onClick="makeResultwin('xmlAuditoria_Acceso-4.php?xfc='+$('fc').value+'&IDB='+$('IDB').value,'box5');" value="Buscar">
	</div>
</div>
...
<div id="box5" style="background:#033; float:left">
	<? include "xmlAuditoria_Acceso-4.php"; ?>
</div>
