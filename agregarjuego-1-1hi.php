<div id='tablemenu'>
  ...
  ?>
  <div id="box13" style="width:380px; background:#257EB7">
    <input type="submit" name="Submit" value="Agregar Juego" onclick="javascript: yq=true;makeRequest('agregarjuegohi.php?fc=0');" />
          ...
          <tbody>
            ...
            if (mysqli_num_rows($result) != 0) :
              ...
              while ($row = mysqli_fetch_array($result)) {
                ...
                echo "</span></td>";
                $vc = "'agregarjuegohi.php?fc=" . $row["IDJug"] . "'";
    ...
    <script>
      Nifty('div#box13', 'big');
      new xTabPanelGroup('tpg2', 375, 450, 0, 'tabPanel', 'tabGroup', 'tabDefault', 'tabSelected');
    </script>