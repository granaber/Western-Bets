        ...
        <div class="navbar">
            <div class="navbar-inner">
                <div class="container-fluid">
                    <a class="brand" href="https://github.com/tubalmartin/YUI-CSS-compressor-PHP-port">YUI CSS compressor
                        PHP port</a>
                </div>
            </div>
        </div>
                ...
                <div id="body" class="span9">
                    ...
                    <div class="well">
                        ...
                        <div id="output-container" class="hide">
                            ...
                            <span class="help-block">Original size: <span id="original-size"></span> bytes | Compressed
                                size: <span id="compressed-size"></span> bytes | Bytes saved: <span id="bytes-saved"></span>
                                | Compression ratio: <span id="compression-ratio"></span>%</span>
                ...
                <div id="sidebar" class="span3">
                    <form id="options-form">
                        ...
                        <fieldset>
                            ...
                            <div class="control-group">
                                <label class="checkbox">
                                    <input type="checkbox" name="remove_important_comments" value="1"> Remove important
                                    comments
                                </label>
                            </div>
                        </fieldset>
                        <fieldset>
                            ...
                            <div class="control-group">
                                <label class="checkbox">
                                    <input type="checkbox" name="raise_php" value="1" checked="checked"> Raise PHP
