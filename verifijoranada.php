...
if ($tipo == 4) :
	...
	if (mysqli_num_rows($result) != 0) :
		...
		echo '<th width="26" bgcolor="#FFFFFF"><div align="center">P1</div></th>';
		echo '<th width="26" bgcolor="#FFFFFF"><div align="center">P2</div></th>';
		echo '<th width="26" bgcolor="#FFFFFF"><div align="center">P3</div></th>';
		echo '<th width="26" bgcolor="#FFFFFF"><div align="center">P4</div></th>';
		...
		for ($i = 1; $i <= $row['Cantcarr']; $i++) {
			...
			$result2 = mysqli_query($GLOBALS['link'], "SELECT * FROM _ganadores where idcn=" . $idcn . " and carr=" . $i);
			...
			echo ' <tr id="c' . $i . '" bgcolor="' . $colort . '">
			   <th> <img src="media/estrella.png" width="16" height="16" onclick="grabar_ganadores(event);"/> </th>
			  ...
			  <th  width="26" ><input id="p' . $i . '2" type="text" size="5" value="' . $pp[1] . '" onkeyup="pulsart(event,' . $b2 . ');" ' . $en . '></th>
			  <th  width="26" ><input id="p' . $i . '3" type="text" size="5" value="' . $pp[2] . '" onkeyup="pulsart(event,' . $b3 . ');" ' . $en . '></th>
			  <th  width="26" ><input id="p' . $i . '4" type="text" size="5" value="' . $pp[3] . '" onkeyup="pulsart(event,' . $b4 . ');" ' . $en . '></th>';
			if ($cr != 1) :
