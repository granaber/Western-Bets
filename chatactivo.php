<script>
    ...
    (function(a) {
        a.cometchat = function() {
            ...
            D[0] = "Opciones Sistema de Mensaje";
            D[2] = "Mi Estatus";
            D[3] = "EnLinea";
            D[4] = "Ocupado";
            D[5] = "Oculto";
            D[6] = "";
            D[7] = '';
            D[8] = "No se Ha Enviado el Login";
            D[9] = "En Linea";
            D[10] = "Yo";
            D[11] = "Ir a Fuera de Linea";
            D[12] = "Inicializando...";
            D[13] = "Sonido Desabilitado ";
            D[14] = "Tu No tienes usuarios en la Lista , Por Favor Contacte al Administrador";
            ...
            O[0] = new Array("home.png", "Salir del Sistema", "javascript:windows.reload()");
            ...
            function T(ax, au, ar) {
                if (a("#cometchat_tooltip").length > 0) {
                    ...
                    a("body").append('<div id="cometchat_tooltip"><div class="cometchat_tooltip_content">' + au +
                        "</div></div>")
                }
                var aw = a("#" + ax).offset();
                var at = a("#" + ax).width();
                ...
                if (ar == 1) {
                    a("#cometchat_tooltip").css("bottom", 29).css("left", (aw.left + at) - 16).css("display",
                        "block").addClass("cometchat_tooltip_left")
                } else {
                    a("#cometchat_tooltip").css("bottom", 29).css("left", (aw.left + at) - av + 12).css("display",
                        "block").removeClass("cometchat_tooltip_left")
                }
                if (A) {
                    a("#cometchat_tooltip").css("position", "absolute");
                    a("#cometchat_tooltip").css("top", parseInt(a(window).height()) - parseInt(a(
                            "#cometchat_tooltip").css("bottom")) - parseInt(a("#cometchat_tooltip").height()) +
                        a(window).scrollTop() + "px")
                }
            }
                    ...
                    if (message != "") {
                        a.post(h + "cometchat_send.php", {
                            ...
                            if (av) {
                                ...
                                a("#cometchat_user_" + au + "_popup .cometchat_tabcontenttext").scrollTop(a(
                                        "#cometchat_user_" + au + "_popup .cometchat_tabcontenttext")[0]
                                    .scrollHeight)
                            }
                            j = 1;
                            if (V > ap) {
            ...
            function ac(av, au, aw) {
                ...
                if (ar > at) {
                    ...
                    if (at > au.clientHeight) {
                        ...
                        a("#cometchat_user_" + aw + "_popup .cometchat_tabcontenttext").css("height", 218 - (at +
                            4) + "px")
                    }
                } else {
                    a(au).css("overflow-y", "auto")
                }
                a("#cometchat_user_" + aw + "_popup .cometchat_tabcontenttext").scrollTop(a("#cometchat_user_" +
                    aw + "_popup .cometchat_tabcontenttext")[0].scrollHeight)
            }
            ...
            function S() {
                a("<span/>").attr("id", "cometchat_optionsbutton").addClass("cometchat_tab").addClass(
                    "cometchat_optionsimages").appendTo(a("#cometchat_base"));
                a("<div/>").attr("id", "cometchat_optionsbutton_popup").addClass("cometchat_tabpopup").css(
                    "display", "none").html('<div class="cometchat_userstabtitle">' + D[0] +
                    '</div><div class="cometchat_tabsubtitle">' +
                    'Realizado por <a href="https://www.saamqx.net" target="_blank"> SERBERINCA</a>' +
                    '</div><div class="cometchat_tabcontent" style="background-image: url(' + h +
                    'images/tabbottomoptions.gif);padding:5px;padding-bottom:10px;"><strong>' + D[2] +
                    '</strong><br/><textarea class="cometchat_statustextarea"></textarea><span style="float:left" class="cometchat_user_available"></span><span class="cometchat_optionsstatus available">' +
                    D[3] +
                    '</span><span class="cometchat_optionsstatus2 cometchat_user_busy"></span><span class="cometchat_optionsstatus busy">' +
                    D[4] +
                    '</span><span class="cometchat_optionsstatus2 cometchat_user_invisible"></span><span class="cometchat_optionsstatus invisible">' +
                    D[5] +
                    '</span><br clear="all"/><div style="border-top:1px solid #eeeeee;margin-top:10px;padding-top:4px;"><span><input type="checkbox" id="cometchat_soundnotifications" style="vertical-align: -2px;">' +
                    D[13] +
                    '</span></div><div style="border-top:1px solid #eeeeee;padding-top:10px;margin-top:4px;"><span><strong>' +
                    D[6] + "</strong><br/><br/>" + D[7] + "</span></div>").appendTo(a("body"));
                ...
                a("#cometchat_optionsbutton").click(function() {
                    if (u == 0) {
                        ...
                        a("#cometchat_tooltip").css("display", "none");
                        a("#cometchat_optionsbutton_popup").css("left", a("#cometchat_optionsbutton")
                            .position().left - 171).css("bottom", "24px");
                        ...
                        a("#cometchat_userstab_popup").removeClass("cometchat_tabopen");
                        a("#cometchat_userstab").removeClass("cometchat_userstabclick").removeClass(
                            "cometchat_tabclick");
                        K("buddylist", "0");
            ...
            function L(ay, av, ar, ax, at, aw) {
                    ...
                    if (!a("#cometchat_user_" + ay).hasClass("cometchat_tabclick")) {
                        if (at != 1) {
                            if (ak != "") {
                                ...
                                a("#cometchat_user_" + ak).removeClass("cometchat_tabclick").removeClass(
                                    "cometchat_usertabclick");
                                ak = ""
                            }
                            if ((a("#cometchat_user_" + ay).offset().left < (a("#cometchat_chatboxes").offset()
                                    .left + a("#cometchat_chatboxes").width())) && (a("#cometchat_user_" + ay)
                                    .offset().left - a("#cometchat_chatboxes").offset().left) >= 0) {
                ...
                a("<span/>").attr("id", "cometchat_user_" + ay).addClass("cometchat_tab").html(
                    '<div style="float:left">' + shortname + "</div>").appendTo(a("#cometchat_chatboxes_wide"));
                a("#cometchat_user_" + ay).append('<div class="cometchat_closebox_bottom_status cometchat_' + ar +
                    '"></div>');
                ...
                a("<div/>").attr("id", "cometchat_user_" + ay + "_popup").addClass("cometchat_tabpopup").css(
                    "display", "none").html('<div class="cometchat_tabtitle"><div class="cometchat_name">' +
                    longname + '</div></div><div class="cometchat_tabsubtitle">' + ax +
                ...
                a("#cometchat_user_" + ay + "_popup .cometchat_tabtitle").append(
                    '<div class="cometchat_closebox"></div><br clear="all"/>');
                a("#cometchat_user_" + ay + "_popup .cometchat_tabtitle .cometchat_closebox").mouseenter(
                    function() {
                        a(this).addClass("cometchat_chatboxmouseoverclose");
                        a("#cometchat_user_" + ay + "_popup .cometchat_tabtitle").removeClass(
                            "cometchat_chatboxtabtitlemouseover")
                    });
                a("#cometchat_user_" + ay + "_popup .cometchat_tabtitle .cometchat_closebox").mouseleave(
                    function() {
                        a(this).removeClass("cometchat_chatboxmouseoverclose");
                        a("#cometchat_user_" + ay + "_popup .cometchat_tabtitle").addClass(
                            "cometchat_chatboxtabtitlemouseover")
                    });
                ...
                a("#cometchat_user_" + ay).click(function() {
                    ...
                    if (a(this).hasClass("cometchat_tabclick")) {
                        ...
                        a("#cometchat_user_" + ay + " .cometchat_closebox_bottom").removeClass(
                        ...
                        if (ak != "") {
                            ...
                            a("#cometchat_user_" + ak).removeClass("cometchat_tabclick").removeClass(
                                "cometchat_usertabclick");
                            a("#cometchat_user_" + ak + " .cometchat_closebox_bottom").removeClass(
                                "cometchat_closebox_bottom_click");
                            ak = ""
                        }
                        if ((a("#cometchat_user_" + ay).offset().left - a("#cometchat_chatboxes").offset()
                        ...
                        a("#cometchat_user_" + ay + "_popup").css("left", a("#cometchat_user_" + ay)
                            .position().left - 62).css("bottom", "24px");
                        a(this).addClass("cometchat_tabclick").addClass("cometchat_usertabclick");
                        a("#cometchat_user_" + ay + "_popup").addClass("cometchat_tabopen");
                        a("#cometchat_user_" + ay + " .cometchat_closebox_bottom").addClass(
                            "cometchat_closebox_bottom_click");
                        K("openChatboxId", ay);
                        ak = ay;
                        if (a("#cometchat_user_" + ay + "_popup .cometchat_tabcontenttext").html() == "" &&
                            f("initialize") != 1) {
                            N(ay)
                        }
                        if (A) {
                            a("#cometchat_user_" + ak + "_popup").css("position", "absolute");
                            a("#cometchat_user_" + ak + "_popup").css("top", parseInt(a(window).height()) -
                                parseInt(a("#cometchat_user_" + ak + "_popup").css("bottom")) -
                                parseInt(a("#cometchat_user_" + ak + "_popup").height()) + a(window)
                                .scrollTop() + "px")
                        }
                    }
                    a("#cometchat_user_" + ay + "_popup .cometchat_tabcontenttext").scrollTop(a(
                            "#cometchat_user_" + ay + "_popup .cometchat_tabcontenttext")[0]
                        .scrollHeight);
                ...
                c();
                if (a("#cometchat_user_" + ay + "_popup .cometchat_tabcontenttext").html() == "" && f(
                        "initialize") != 1) {
                    N(ay)
                }
            }
                            ...
                            a.each(av, function(aw, ax) {
                                if (aw == "messages") {
                                    a.each(ax, function(az, ay) {
                                        ...
                                        at += ('<div class="cometchat_chatboxmessage" id="cometchat_message_' +
                                            ay.id +
                                            '"><span class="cometchat_chatboxmessagefrom"><strong>' +
                                            fromname +
                                            '</strong>:&nbsp;&nbsp;</span><span class="cometchat_chatboxmessagecontent">' +
                                            ay.message + "</span></div>")
                                    })
                                }
                            });
                            a("#cometchat_user_" + ar + "_popup .cometchat_tabcontenttext").append(at);
                            a("#cometchat_user_" + ar + "_popup .cometchat_tabcontenttext").scrollTop(a(
                                    "#cometchat_user_" + ar + "_popup .cometchat_tabcontenttext")[0]
                                .scrollHeight)
                        }
                    }
                })
            ...
            function ae(au, ar, at) {
                ...
                if (ar == 0) {
                    ...
                    if (a("#cometchat_user_" + au + " .cometchat_tabalert").length > 0) {
                        ...
                        a("<div/>").css("top", "-5px").addClass("cometchat_tabalert").html(ar).appendTo(a(
                            "#cometchat_user_" + au))
                    }
                }
                c();
            ...
            function Q() {
                a("<span/>").attr("id", "cometchat_userstab").addClass("cometchat_tab").html(
                    '<span id="cometchat_userstab_icon"></span><span id="cometchat_userstab_text" style="float:left">' +
                    D[12] + "</span>").appendTo(a("#cometchat_base"));
                a("<div/>").attr("id", "cometchat_userstab_popup").addClass("cometchat_tabpopup").css("display",
                    "none").html('<div class="cometchat_userstabtitle">' + D[9] +
                    '</div><div class="cometchat_tabsubtitle"><a class="cometchat_gooffline">' + D[11] +
                    '</a></div><div class="cometchat_tabcontent" style="background-image: url(' + h +
                    'images/tabbottomwhosonline.gif);height:200px;padding-top:5px;padding-bottom:5px;"><div class="cometchat_userscontent"><div class="cometchat_userslist_available"></div><div class="cometchat_userslist_busy"></div><div class="cometchat_userslist_away"></div><div class="cometchat_userslist_offline"></div></div>'
                ).appendTo(a("body"));
                ...
                a("#cometchat_userstab").click(function() {
                    ...
                    a("#cometchat_userstab_popup").css("left", a("#cometchat_userstab").position().left +
                        16).css("bottom", "24px");
            ...
            function t() {
                ...
                if (a("#cometchat_chatboxes_wide").width() <= (a("#cometchat_base").width() - 226 - av - 75)) {
                    ...
                    a("#cometchat_chatboxes").css("width", Math.floor((a("#cometchat_base").width() - 226 - av -
                        75) / 152) * 152);
                ...
                a("#cometchat_optionsbutton_popup").css("left", a("#cometchat_optionsbutton").position().left - 171)
                    .css("bottom", "24px");
                a("#cometchat_userstab_popup").css("left", a("#cometchat_userstab").position().left + 16).css(
                    "bottom", "24px");
                if (ak != "") {
                    if ((a("#cometchat_user_" + ak).offset().left < (a("#cometchat_chatboxes").offset().left + a(
                            "#cometchat_chatboxes").width())) && (a("#cometchat_user_" + ak).offset().left - a(
                            "#cometchat_chatboxes").offset().left) >= 0) {
                        a("#cometchat_user_" + ak + "_popup").css("left", a("#cometchat_user_" + ak).position()
                            .left - 62).css("bottom", "24px")
                    } else {
                        a("#cometchat_user_" + ak + "_popup").removeClass("cometchat_tabopen");
                        a("#cometchat_user_" + ak).removeClass("cometchat_tabclick").removeClass(
                            "cometchat_usertabclick");
                        var au = ((a("#cometchat_user_" + ak).offset().left - a("#cometchat_chatboxes_wide")
                            .offset().left)) - ((Math.floor((a("#cometchat_chatboxes").width() / 152)) - 1) * 152);
            ...
            function G() {
                ...
                a(".cometchat_tabalert").each(function() {
                    if ((a(this).parent().offset().left < (a("#cometchat_chatboxes").offset().left + a(
                            "#cometchat_chatboxes").width())) && (a(this).parent().offset().left - a(
                            "#cometchat_chatboxes").offset().left) >= 0) {
                        a(this).css("display", "block");
                        a(this).css("left", a(this).parent().offset().left + a(this).parent().width() - 30)
                    } else {
                        a(this).css("display", "none");
                        if ((a(this).parent().offset().left - a("#cometchat_chatboxes").offset().left) >=
                            0) {
                            var ar = a("#cometchat_chatbox_right").offset().left + a(
                                "#cometchat_chatbox_right").width() - 30;
                            a("#cometchat_chatbox_right .cometchat_tabalertlr").css("left", ar);
                            a("#cometchat_chatbox_right .cometchat_tabalertlr").html(parseInt(a(
                                    "#cometchat_chatbox_right .cometchat_tabalertlr").html()) +
                                parseInt(a(this).html()));
                            a("#cometchat_chatbox_right .cometchat_tabalertlr").css("display", "block")
                        } else {
                            var ar = a("#cometchat_chatbox_left").offset().left + a(
                                "#cometchat_chatbox_left").width() - 22;
                            a("#cometchat_chatbox_left .cometchat_tabalertlr").css("left", ar);
                            a("#cometchat_chatbox_left .cometchat_tabalertlr").html(parseInt(a(
                                "#cometchat_chatbox_left .cometchat_tabalertlr").html()) + parseInt(
                                a(this).html()));
            ...
            function an() {
                ...
                if ((a("#cometchat_chatboxes").scrollLeft() + a("#cometchat_chatboxes").width()) == a(
                    ...
                    var at = Math.floor((a("#cometchat_chatboxes_wide").width() - (a("#cometchat_chatboxes")
                        .scrollLeft() + a("#cometchat_chatboxes").width())) / 152);
                ...
                if ((!a("#cometchat_chatbox_right").hasClass("cometchat_chatbox_right_last") && av == 1) || (a(
                        "#cometchat_chatbox_right").hasClass("cometchat_chatbox_right_last") && av == 0) || (!a(
                        "#cometchat_chatbox_right").hasClass("cometchat_chatbox_lr") && ar == 1) || (a(
                        "#cometchat_chatbox_right").hasClass("cometchat_chatbox_lr") && ar == 0)) {
                    t()
                }
            }
            ...
            function r(at) {
                ...
                a("#cometchat_chatboxes").scrollTo(at, ar, function() {
                    if (ak != "") {
                        if ((a("#cometchat_user_" + ak).offset().left < (a("#cometchat_chatboxes").offset()
                                .left + a("#cometchat_chatboxes").width())) && (a("#cometchat_user_" + ak)
                                .offset().left - a("#cometchat_chatboxes").offset().left) >= 0) {
                            a("#cometchat_user_" + ak).click()
                        } else {
                            ak = ""
            ...
            function Y(ax, ar, av, au, at, aw) {
                ...
                if (a("#cometchat_message_" + at).length > 0) {
                    ...
                    a("#cometchat_user_" + ax + "_popup .cometchat_tabcontenttext").append(
                        '<div class="cometchat_chatboxmessage" id="cometchat_message_' + at +
                        '"><span class="cometchat_chatboxmessagefrom"><strong>' + fromname +
                        '</strong>:&nbsp;&nbsp;</span><span class="cometchat_chatboxmessagecontent">' + ar +
                        "</span></div>")
                }
                if (ak != ax && au != 1) {
                    ae(ax, 1, 1)
            ...
            function F() {
                ...
                a.ajax({
                    ...
                    dataType: "json",
                    success: function(av) {
                        $('MensajeTXT').innerHTML = av.mensaje;
                        if (av) {
                            var au = 0;
                            a.each(av, function(aw, ax) {
                                if (aw == "buddylist") {
                                    ...
                                    a.each(ax, function(az, ay) {
                                        ...
                                        if (a("#cometchat_user_" + ay.id).length > 0) {
                                            ...
                                            a("#cometchat_user_" + ay.id +
                                                " .cometchat_closebox_bottom_status"
                                            ).addClass("cometchat_" + ay.status);
                                            if (a("#cometchat_user_" + ay.id + "_popup")
                                                .length > 0) {
                                                a("#cometchat_user_" + ay.id +
                                                        "_popup .cometchat_tabsubtitle")
                                                    .html(ay.message)
                                            }
                                        }
                                        ...
                                        totalFriendsNumber++;
                                        at[ay.status] +=
                                            '<div id="cometchat_userlist_' + ay.id +
                                            '" class="cometchat_userlist" onmouseover="jQuery(this).addClass(\'cometchat_userlist_hover\');" onmouseout="jQuery(this).removeClass(\'cometchat_userlist_hover\');"><span class="cometchat_userscontentname">' +
                                            longname +
                                ...
                                if (buddylistreceived == 1) {
                                    ...
                                    for (buddystatus in at) {
                                        a("#cometchat_userstab_popup .cometchat_tabcontent .cometchat_userscontent .cometchat_userslist_" +
                                            buddystatus).html(at[buddystatus]);
                                        a("#cometchat_userstab_popup .cometchat_tabcontent .cometchat_userscontent .cometchat_userslist_" +
                                            buddystatus).children().click(function() {
                                            C(this)
                                        })
                                    }
                                    a("#cometchat_userstab_text").html(D[9] + " (" +
                                        onlineNumber + ")");
                                    E = onlineNumber;
                                    if (totalFriendsNumber == 0) {
                                        a("#cometchat_userstab_popup .cometchat_tabcontent .cometchat_userscontent .cometchat_userslist_available")
                                            .html('<div class="cometchat_nofriends">' + D[14] +
                                                "</div>")
                                    }
                                    buddylistreceived = 0
                                }
                                if (aw == "loggedout") {
                                    a("#cometchat_optionsbutton").addClass(
                                    ...
                                    a(".cometchat_tabopen").css("cssText",
                                    ...
                                    a.each(ax, function(ay, az) {
                                        ...
                                        if (ay == "status") {
                                            if (az == "offline") {
                                                ...
                                                B();
                                                a("#cometchat_userstab_icon").addClass(
                                                    "cometchat_user_" + az + "2");
                                                a("#cometchat_optionsbutton_popup ." +
                                                    az).css("text-decoration",
                                                    "underline")
                                            }
                                        }
                                    })
                                ...
                                if (aw == "updatesession" && ag != 1 && f("updatesession") !=
                                    1) {
                                    aa("updatingsession", "1");
                                    a.each(ax, function(ay, aB) {
                                        if (ay == "buddylist") {
                                            if ((aB == 0 && a("#cometchat_userstab")
                                                    .hasClass("cometchat_tabclick")) ||
                                                (aB == 1 && !(a("#cometchat_userstab")
                                                    .hasClass("cometchat_tabclick")
                                                ))) {
                                                a("#cometchat_userstab").click()
                                            }
                                ...
                                if (aw == "messages") {
                                    a.each(ax, function(aA, ay) {
                                        ...
                                        if ((ak) == (ay.from)) {
                                            ...
                                            if (a("#cometchat_message_" + ay.id)
                                                .length > 0) {
                                                a("#cometchat_message_" + ay.id +
                                                    " .cometchat_chatboxmessagecontent"
                                                ).html(ay.message)
                                            } else {
                                                ar += ('<div class="cometchat_chatboxmessage" id="cometchat_message_' +
                                                    ay.id +
                                                    '"><span class="cometchat_chatboxmessagefrom"><strong>' +
                                                    fromname +
                                                    '</strong>:&nbsp;&nbsp;</span><span class="cometchat_chatboxmessagecontent">' +
                                            ...
                                            var aB = 0;
                                            if (a("#cometchat_user_" + ay.from).length >
                                                0) {} else {
                                                aB = 1
                                            }
                                            Y(ay.from, ay.message, ay.self, ay.old, ay
                                                .id);
                                            if (ak == "" && W == 1 && aB == 1) {
                            ...
                            if (ak != "" && au > 0) {
                                a("#cometchat_user_" + ak + "_popup .cometchat_tabcontenttext").append(
                                    ar);
                                a("#cometchat_user_" + ak + "_popup .cometchat_tabcontenttext")
                                    .scrollTop(a("#cometchat_user_" + ak +
            ...
            function k() {
                ...
                for (var ar = 0; ar < ao; ar++) {
                    var at = O[ar];
                    a("#cometchat_base").append('<div id="cometchat_trayicon_' + ar +
                        '" class="cometchat_trayicon"><img src=' + h + "images/icons/" + at[0] + "></div>")
                }
                ...
                a("<span/>").css("top", "-5px").css("display", "none").addClass("cometchat_tabalertlr").appendTo(a(
            ...
            function J() {
                ...
                a("#cometchat_userstab_popup").css("top", parseInt(a(window).height()) - parseInt(a(
                    "#cometchat_userstab_popup").css("bottom")) - parseInt(a("#cometchat_userstab_popup")
                    .height()) + a(window).scrollTop() + "px");
                a("#cometchat_optionsbutton_popup").css("top", parseInt(a(window).height()) - parseInt(a(
                    "#cometchat_optionsbutton_popup").css("bottom")) - parseInt(a(
                    "#cometchat_optionsbutton_popup").height()) + a(window).scrollTop() + "px");
                if (a("#cometchat_tooltip").length > 0) {
                    a("#cometchat_tooltip").css("top", parseInt(a(window).height()) - parseInt(a(
                            "#cometchat_tooltip").css("bottom")) - parseInt(a("#cometchat_tooltip").height()) +
                        a(window).scrollTop() + "px")
                ...
                if (ak != "") {
                    a("#cometchat_user_" + ak + "_popup").css("position", "absolute");
                    a("#cometchat_user_" + ak + "_popup").css("top", parseInt(a(window).height()) - parseInt(a(
                        "#cometchat_user_" + ak + "_popup").css("bottom")) - parseInt(a("#cometchat_user_" +
                        ak + "_popup").height()) + a(window).scrollTop() + "px")
                }
            }
            k()
        }
    ...
    (function(c) {
        ...
        c.fn._scrollable = function() {
            return this.map(function() {
                var e = this,
                    d = !e.nodeName || c.inArray(e.nodeName.toLowerCase(), ["iframe", "#document", "html",
                        "body"
                    ]) != -1;
                if (!d) {
                    return e
    ...
    deconcept.SWFObject.prototype = {
        ...
        getSWFHTML: function() {
            ...
            if (navigator.plugins && navigator.mimeTypes && navigator.mimeTypes.length) {
                ...
                _19 = "<object id=\"" + this.getAttribute("id") +
                    "\" classid=\"clsid:D27CDB6E-AE6D-11cf-96B8-444553540000\" width=\"" + this.getAttribute(
                        "width") + "\" height=\"" + this.getAttribute("height") + "\" style=\"" + this.getAttribute(
                        "style") + "\">";
        ...
        write: function(_20) {
            if (this.getAttribute("useExpressInstall")) {
                ...
                if (this.installedVer.versionIsValid(_21) && !this.installedVer.versionIsValid(this.getAttribute(
                        "version"))) {
            ...
            if (this.skipDetect || this.getAttribute("doExpressInstall") || this.installedVer.versionIsValid(this
    ...
    deconcept.SWFObjectUtil.getPlayerVersion = function() {
        ...
        if (navigator.plugins && navigator.mimeTypes.length) {
            ...
            if (x && x.description) {
                _23 = new deconcept.PlayerVersion(x.description.replace(/([a-zA-Z]|\s)+/, "").replace(
                    /(\s+r|\s+b[0-9]+)/, ".").split("."));
            }
        } else {
