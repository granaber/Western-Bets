...
<div id="box5" style="background:#FC0">
  <?php
  ...
  <table width="440" border="0" cellspacing="0">
    <tr bgcolor="#FC0">
      <th bgcolor="#FC0"></th>
      <th colspan="4" bgcolor="#FC0">
        <div align="center" class="Estilo4d1">Cierre de ventas</div>
        <div align="right"></div>
      </th>
    </tr>
    <tr bgcolor="#FC0">
    ...
    <tr bgcolor="#FC0">
      <th bgcolor="#FC0"></th>
      <th bgcolor="#FC0" class="Estilo3d1">
        <div align="right">Desde:</div>
      </th>
      <th width="144" bgcolor="#FC0"><input name="fc" type="text" id="fc1" size="10" value="<?php echo date("d/n/Y"); ?>" /></th>
      <th width="137" bgcolor="#FC0">
        <div align="right" class="Estilo3d1">Hasta:</div>
      </th>
      <th bgcolor="#FC0"><input name="fc" type="text" id="fc2" size="10" value="<?php echo date("d/n/Y"); ?>" /></th>
    </tr>
    ...
    <tr bgcolor="#FC0">
      <th width="1" bgcolor="#FC0"></th>
      <th width="80" bgcolor="#FC0">&nbsp;</th>
      <th colspan="2" bgcolor="#FC0">&nbsp;</th>
      <th width="68" bgcolor="#FC0"><img src="media/impripan.png" alt="Imprimir" onclick="imprimirreddprt22();" />&nbsp;&nbsp;</th>
    </tr>
  </table>
</div>
