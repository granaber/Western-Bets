...
<section>
  <h4 class=<?= $dark ? 'text-white' : 'text-dark' ?> mb-3 text-center">Resultados (Animalitos)</h4>
  ...
  <div class="form-group text-center" style="width: 100%;">
    ...
    <button type="button" class="btn btn-warning" onclick="handleReportResutlAnimalitos()">Mostrar Reporte</button>
  </div>
</section>