 <?php
  ...
  ?>
 <div id="box1" style="background: #06C; width:405px">


   <table width="400" border="0" cellspacing="0">
     <tr>
       <th colspan="3">
         <div align="center" style="color:#FFFFFF; font-size:14px"> Ganadores</div>
       </th>
       <th>
     ...
     <tr>
       ...
       <td width="159"><input type="submit" name="Submit3" value="Buscar" onClick="datosganadores();" /></td>
     </tr>
   </table>
