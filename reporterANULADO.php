...
if (true) :
	...
	echo '  <tr>';
	echo '   <th colspan="7" scope="col">Reporte de Jugadas Anuladas</th>';
	echo '  </tr>';
	echo '  <tr>';
	echo '   <th colspan="7" scope="col">' . $ttex . '</th>';
	echo '  </tr>';
	echo '  <tr>';
	echo '   <th colspan="7" scope="col">' . $ttex2 . '</th>';
	echo '  </tr>';
	echo '  <tr>';
	echo '   <th  scope="col">Serial</th>';
	echo '   <th  scope="col">Hora del Ticket</th>';
	echo '   <th  scope="col">Fecha</th>';
	echo '   <th  scope="col">Hora de Eliminado/Motivo</th>';
	echo '   <th  scope="col"></th>';
	echo '   <th  scope="col">Letra</th>';
	echo '   <th  scope="col">Monto Bs.f</th>';
	echo '  </tr>';
	echo '  <tr>';
	echo '   <th colspan="7" scope="col">*****************************************</th>';
	echo '  </tr>';
	...
	while ($row = mysqli_fetch_array($result)) {
		...
		$result2 = mysqli_query($GLOBALS['link'], "SELECT *  FROM _tjugadabb  where IDC='" . $row['IDC'] . "'    and activo=2 " . $add . " Order By Serial");
		...
		while ($row2 = mysqli_fetch_array($result2)) {
			...
			echo '   <th scope="col">' . $row2['hora'] . '</th>';
			echo '   <th scope="col">' . $fch . '</th>';
			echo '   <th scope="col">' . $row2['hc'] . '</th>';
			echo '   <th scope="col"></th>';
			echo '   <th scope="col">' . $row2['IDC'] . '</th>';
