...
?>
	...
	<form id="from1" name="from1" method="POST" action="crd-1-8.php">
		<table width="815" border="0">
			<tr>
				<td width="114">Letra:</td>
				<td width="643"><? echo $IDC; ?></td>
			</tr>
			<tr>
				<td>Fecha de Pago:</td>
...
<? else : ?>
	...
	<script>
		alert('Este cliente no tiene deuda que Cancelar (MONTO A FAVOR DEL CLIENTE Bsf. <? echo number_format(-1 * $debo, 2, ',', '.');  ?>)');
	</script>
