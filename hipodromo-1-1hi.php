...
?>
<div id='box15'>
	<span style="color:#FFFF00; font-size:18px"><strong>Hipodromo Internacionales</strong></span>
	<table border="0" cellpadding="3" cellspacing="0" width="505">
		<tbody>
			<?php
			$result = mysqli_query($GLOBALS['link'], "SELECT * FROM _hipodromoshi ");
			...
			if (mysqli_num_rows($result) != 0) :
				...
				while ($row = mysqli_fetch_array($result)) {
					...
					echo "</span></td>";
					$vc = "'hipodromohi.php?fc=" . $row["_idhipo"] . "'";
	...
	<p>
		...
		<input type="submit" name="Submit" value="Agregar Hipodromo" onclick="makeRequest('hipodromohi.php?fc=0');" />
