<?
$ch = curl_init('http://parlayenlinea.tk:7890/capture');
...
// $grid->render_sql("SELECT * From _tbligas where  IDJsk=".$IDJsk." and Liga in (select Liga from _tbvalidas where estatus=1)","Liga" ,"sel,Liga,Descripcion");
$grid->render_sql("SELECT * From _tbligas where  IDJsk=" . $IDJsk . " order by Liga ASC", "Liga", "sel,Liga,Descripcion");
