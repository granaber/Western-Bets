...
function dhtmlXContainer(obj) {
  ...
  this.setContent = function (data) {
    ...
    this.dhxcont.innerHTML =
      "<div id='dhxMainCont' style='position: relative;left: 0px;top: 0px;overflow: hidden;'></div>" +
  ...
  this.obj.moveContentTo = function (cont) {
    ...
    if (this.toolbar != null) {
      cont.dhxcont.insertBefore(
        document.getElementById(this.toolbarId),
        cont.dhxcont.childNodes[cont.menu != null ? 1 : 0]
      )
    ...
    if (this.sb != null) {
      cont.dhxcont.insertBefore(
        document.getElementById(this.sbId),
        cont.dhxcont.childNodes[cont.dhxcont.childNodes.length - 1]
      )
      cont.sb = this.sb
      cont.sbId = this.sbId
  ...
  this.obj.adjustContent = function (parentObj, offsetTop, marginTop, notCalcWidth, offsetBottom) {
    ...
    if (notCalcWidth !== true) {
      ...
      if (this.dhxcont.mainCont.offsetWidth > this.dhxcont.clientWidth)
        this.dhxcont.mainCont.style.width =
          Math.max(0, this.dhxcont.clientWidth * 2 - this.dhxcont.mainCont.offsetWidth) + 'px'
    }
    ...
    if (this.dhxcont.mainCont.offsetHeight > this.dhxcont.clientHeight)
      this.dhxcont.mainCont.style.height =
        Math.max(0, this.dhxcont.clientHeight * 2 - this.dhxcont.mainCont.offsetHeight) + 'px'
    this.dhxcont.mainCont.style.height =
      Math.max(0, parseInt(this.dhxcont.mainCont.style.height) - menuOffset - toolbarOffset - statusOffset) + 'px'
  }
