...
<div id="box6" style="width:500px">
  ...
  <table width="440" border="0" cellspacing="0">
    <tr>
      <th></th>
      <th colspan="4">
        <div align="center" class="Estilo4d1">Reporte Detallado de Ventas/Premio Por Carrera</div>
        <div align="right"></div>
      </th>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <th width="80">&nbsp;</th>
      <th colspan="2">&nbsp;</th>
      <th width="68"><input name="" type="button" onclick="impri_ventas_premio_tablas(<? echo $accesogp; ?>);" value="Imprimir Reporte" />&nbsp;&nbsp;</th>
    </tr>
  </table>
</div>
