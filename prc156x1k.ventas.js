...
function exeAcceso() {
  ...
  .then(response=>{
    ...
    if (!eval(arrInfo[0])) {
      ...
      switch (arrInfo[1]) {
        case "1":
          document.getElementById("repuesta").innerHTML = '<div class="w-full absolute lg:px-[2.3rem] px-[0.7rem] mb-4 text-sm text-yellow-800 rounded-sm bg-yellow-50 dark:bg-gray-800 dark:text-yellow-300" role="alert">Usuario Bloqueado!</div>';
          break;
        case "3":
          nalert("HORARIO", "ESTA FUERA DEL HORARIO PARA LA VENTA!");
          break;
        case "4":
          document.getElementById("repuesta").innerHTML = '<div class="w-full absolute lg:px-[2.3rem] px-[0.7rem] mb-4 text-sm text-yellow-800 rounded-sm bg-yellow-50 dark:bg-gray-800 dark:text-yellow-300" role="alert">Solo se permite acceso a Clientes!</div>';
          break;
        default:
          document.getElementById("repuesta").innerHTML =
            '<div class="w-full absolute lg:px-[2.3rem] px-[0.7rem] mb-4 text-sm text-yellow-800 rounded-sm bg-yellow-50 dark:bg-gray-800 dark:text-yellow-300" role="alert">Su Usuario o Clave es errada!</div>';
      }
  ...
  //       document.getElementById("idusuario").disable = "";
  //       document.getElementById("idclave").disable = "";
  //       document.getElementById("frm-btn").disable = "";
  //       document.getElementById("idusuario").value = "";
  //       document.getElementById("idclave").value = "";
  //       switch (arrInfo[1]) {
  //         case "1":
