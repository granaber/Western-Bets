...
$result = mysqli_query($GLOBALS['link'], "SELECT * FROM _tbreglas_2 Where IDC='$IDC' and IDG=$IDG and Grupo=$Grupo ");
	...
	<table width="289" border="0">
		<tr>
			<td colspan="3" align="center" style="background:#4B79A7; color:#FFF">
				<div align="center" style="font-size:16px">Jugadas Parlay</div>
			</td>
		</tr>
		<tr>
