...
<div align="left">
  ...
  <table width="590" bgcolor="#999999">
    <tr bgcolor="#FFCC33">
      <th colspan="19" align="left" bgcolor="#F1F55C" scope="col"><span id='tj' title="<?php echo $tj; ?>" class="Estilo43">ELECTRONICO</span></th>
    </tr>
    <tr bgcolor="#FFCC33">
      <th colspan="17" align="left" valign="middle" bgcolor="#F1F55C" scope="col"><span class="Estilo3"><strong>N.Ticket:</strong> <span id='numet' title="<?php echo $row2["num"]; ?>" class="Estilo12"><?php echo $row2["num"]; ?> </span>
          </p>
        </span></th>
      <th align="center" valign="middle" bgcolor="#F1F55C" title="<?php echo $row["Multip"]; ?>" scope="col">
        <div align="center">X <?php echo $row["Multip"]; ?></div>
      </th>
      <th align="center" valign="middle" bgcolor="#F1F55C" scope="col">
    ...
    <tr>
      <th width="144" rowspan="<?php echo $row["CantidadCarr"]; ?>" bgcolor="#F1F55C" scope="col">
      ...
      for ($i = 1; $i <= $row["CantidadCarr"]; $i++) {
        ...
        echo '<th width="17" scope="col" bgcolor="#F1F55C" title="' . $cejem . '">' . $i . '.-</th>';
        ...
        echo '<th width="103" bgcolor="#F1F55C" scope="col"></th>';
        echo '</tr>';
      }
      ?>

      <th bgcolor="#F1F55C" scope="row"><label></label></th>
      <th colspan="17" bgcolor="#F1F55C" scope="row"><label> </label>
        <div align="right"><span class="Estilo40">Total Bs.F.</span>
          <input type="text" name="Total" id="Total" />
        </div>
      </th>
      <td bgcolor="#F1F55C">&nbsp;</td>
    </tr>
  </table>
