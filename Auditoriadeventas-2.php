...
$grid->render_sql("SELECT _auditoria_logros.*,_tusu.Usuario as NombreUsu FROM `_auditoria_logros`, _tusu WHERE _auditoria_logros.IDusu= _tusu.IDusu and idj = $IDJ and Grupo=$Grupo And IDB=$IDB and IDP=$IDP and IDDD=$IDDD  and (Valores<>'||||' and  Valores<>'||' )order by ID_Mod Desc", "ID_Mod", "dat_hour,Valores,NombreUsu");
