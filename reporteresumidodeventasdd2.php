  ...
  <table width="440" border="0" cellspacing="0">
    <tr bgcolor="#006699">
      ...
      <th colspan="4" bgcolor="#006699">
        <div align="center" class="Estilo4d1">Reporte de Ventas y Ganacias Resumido por Fecha Prototype II</div>
        <div align="right"></div>
      </th>
    </tr>
    <tr bgcolor="#006699">
    ...
    <tr bgcolor="#006699">
      ...
      <th colspan="2" bgcolor="#006699">&nbsp;</th>
      <th width="68" bgcolor="#006699"><img src="media/impripan.png" alt="Imprimir" onclick="imprimirredd2();" />&nbsp;&nbsp;</th>
    </tr>
  </table>
</div>
