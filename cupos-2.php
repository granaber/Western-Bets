...
$grid->render_sql("SELECT _tdjuegoshi.IDJug as IDJugada  ,_tdjuegoshi.Descrip,_tcupos.* FROM _tdjuegoshi  LEFT JOIN _tcupos  ON _tdjuegoshi.IDJug=_tcupos.IDJug and _tcupos.IDC='" . $IDRelacionado[0] . "' ", "IDJugada", "IDJugada,Descrip,JugadaMaxima,DividendoMaximos");
