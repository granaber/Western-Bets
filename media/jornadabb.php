...
?>
	<div id="fromJornada" style=" background:#BAC6D8;width: 100%; height: 100%; overflow: auto; display: none; font-family: Tahoma; font-size: 11px;">
		<span id='fc' lang='<? echo $fc; ?>'></span><span id='cant_p' lang='<? echo $cant; ?>'></span> <span id='Grupo' lang='<? echo $dp; ?>'></span> <span id='IDB' lang='<? echo  $IDB; ?>'></span>
		<table border="0" cellpadding="0" cellspacing="0">
					...
					<div id="partidos">
						<table border="0" cellspacing="0" cellpadding="0">
							<tr style="background:#BAC6D8">
								<td height="45px">
									<div align="center" style="color: #000"><strong>N.P</strong></div>
								</td>
								<td width="110">
									<div align="center" style="color:#000"><strong>Hora<br />(HH:MM) </strong></div>
								</td>
								<td width="58">
									<div align="center" style="color:#000 "><strong>Equipo(1)</strong></div>
								</td>
								<td width="13">&nbsp;</td>
								<td width="61">
									<div align="center" style="color:#000 "><strong>Equipo(2)</strong></div>
								</td>
									...
									<div style="" id="TabbedPanels1" class="TabbedPanels">
										<ul class="TabbedPanelsTabGroup">
											...
											if (mysqli_num_rows($result) != 0) :
												...
												while ($row3 = mysqli_fetch_array($result)) {
													...
													while ($row2 = mysqli_fetch_array($result2)) {
														...
														echo '<li class="TabbedPanelsTab" tabindex="0" ><div align="center"  style="color:#000000; font-size:9px"><samp id="c' . $row2['IDDD'] . '"/></samp><br /><strong>' . $row3['Descripcion'] . '</strong><br /><strong  style="color:#000">' . $row2['Descripcion'] . '</strong></div></li>';
														/* echo '<td style="background:#3366CC" ><div align="center"  style="color:#000000"><samp id="c'.$row2['IDDD'].'"/></samp><br /><strong>'.$row3['Descripcion'].'</strong><br /><strong  style="color:#FFCC00">'.$row2['Descripcion'].'</strong></div></td>'; */
													}
													$cc++;
												}
												echo '<li class="TabbedPanelsTab" tabindex="0" ><div align="center"  style="color:#000000; font-size:8px"><br /><strong>Pichers/Efectividad</strong><br /><strong  style="color:#F00">Juegos</strong></div></li>';
												echo '<li class="TabbedPanelsTab" tabindex="0" ><div align="center"  style="color:#000000; font-size:8px"><br /><strong>Codigo Equipos</strong><br /><strong  style="color:#F00">CODIGO</strong></div></li>';
											endif;
											...
											if (mysqli_num_rows($result) != 0) :
												...
												echo '<div class="TabbedPanelsContent" ><table width="200" border="0"> ';
											...
											for ($i = 1; $i <= $cant; $i++) {
												...
												echo '<tr bgcolor="' . $bkcolor . '"><td ><div id="np' . $i . '"  lang="' . $np[$i] . '" align="center" style="color:#FFFFFF">' . $np[$i] . '</div></td><td ><div align="center">';
												$uno = "'min" . $i . "'";
												$dos = "'hora" . $i . "'";
												...
												echo ' </div></td><td ><div align="center"><select name="select2" size="1" id="equipo' . $i . '" onchange="colocarTexto(' . $i . ')" >';
          ...
          <td><div align="center" style="color:#FFFFFF"><strong>vs</strong></div></td>
          <td ><div align="center">
             <select name="select2" size="1" id="equipo' . $n . '"  onchange="colocarTexto(' . $n . ')">';
												$result = mysqli_query($GLOBALS['link'], "SELECT * FROM _equiposbb where  ( _equiposbb.Grupo=" . $dp . " or _equiposbb.Grupo1=" . $dp . " or _equiposbb.Grupo2=" . $dp . " ) order by Descripcion,IDE");
												while ($row = mysqli_fetch_array($result)) {
													if ($i <= count($eq2)) {
					...
					<script>
						...
						function clicktoolBar(id) {
							switch (id) {
								case "Cerrar_":
									...
									break;
								case "Importar_":
									makeResultwin('jornadabb-1-5.php?idj=' + $('n_idc').title + '&dp=' + $('Grupo').lang + '&IDB=' + $('IDB').lang + '&fc=' + $('fc').lang, 'tablemenu');
									break;
								case "Modificar_":
									if (idRow != 0) {
										dhxWins1.window("w1").close();
						...
						for (i = 1; i <= cant; i++) {
							...
							$('Equi_' + (i + cant)).innerHTML = $("equipo" + (i + cant)).options[($("equipo" + (i + cant)).value - 1)].text;
						}
					</script>
				<?
			else :
