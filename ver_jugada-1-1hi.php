				...
				default:
					if ($idcn != 0) :
						...
						if ($conse != -2 && $conse != -1) :
							...
							$result = mysqli_query($GLOBALS['link'], "SELECT IDC FROM _tjugadahi where IDCN=" . $idcn . " and IDJug=" . $idj . " Group by IDC Order by IDC");
						...
						if ($conse != -2 && $conse != -1) :
							...
							$resultgrupo = mysqli_query($GLOBALS['link'], "SELECT IDC FROM _tjugadahi where IDCN=" . $idcn . " and IDJug=" . $idj . " Group by IDC Order by IDC");
