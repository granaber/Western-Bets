...
<div id="fromReporte" style=" height:1000px;width:500px; background:  #4B79A7">
  ...
  <table width="440" border="0" cellspacing="0">
    <tr>
      <th width="1"></th>
      <th colspan="4">
        <div align="center" class="Estilo4d1">Reporte de Ventas/Premio DETALLADO</div>
        <div align="right"></div>
      </th>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <th colspan="2" align="left"><select id='tipo'>
          <option value="1">Ventas/Premios</option>
          <option value="2">Premios Pagados</option>
...
<script>
  ...
  function clicktoolBar(id) {
    switch (id) {
      ...
      case "Imprimit_":
        abrir('reportedeventaspremiosDetallado-2.php?desde=' + $("fc1").value + "&hasta=" + $("fc2").value + "&IDC=" + $('con').title + '&tipo=' + $('tipo').value, ' ', 1, 0, 0, 0, 0, 1, 1, 400, 500, 100, 100, 1);
        break;
  ...
  w1.setText('Reporte de Ventas/Premio DETALLADO de ' + $('con').title);
