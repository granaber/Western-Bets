...
$grid->render_sql("Select _registros_de_acceso.*,_tusu.Usuario from _registros_de_acceso,_tusu where _registros_de_acceso.IDusu=_tusu.IDusu", "IDusu", "IDusu,Usuario,SerialdeRegistro,SerialGenerado,Bloquear ");
