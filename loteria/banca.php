...
switch(id){
	case "incluir_":
					 makeResultwin("banca-1.php?op=1","gridbox");
					break;
	case "modificar_":
	                 makeResultwin("banca-1.php?op=2&IDB="+$('idseleccionado').lang,"gridbox");
					break;
	case "Cerrar_":
 ...
 function doOnRowSelected(id){ 
   ...
   function doOnCheck(rowId,cellInd,state){
	...
	createByxml('grid_Banca.xml','SELECT * FROM _tbanca Order by IDB','IDB|Descripcion|Propietario|Estatus');
	mygrid = w1.attachGrid();
	mygrid.setImagePath("codebase/imgs/");
	mygrid.setHeader("ID,Descripcion,Propietario,Status");
