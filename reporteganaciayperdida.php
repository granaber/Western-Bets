...
<div id="box6" style="width:500px; background:#036">
    <?php
    ...
    <table border="0" cellspacing="0" style="line-height: 22px;">
        <tr>
            <th></th>
            <th colspan="4">
                <div align="center" class="Estilo4d1">Reporte de Ganacias y Perdidas Detallado por Fecha</div>
                <div align="right"></div>
            </th>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <th colspan="2">&nbsp;</th>
            <th width="68">
                <button class="button-pv-standard" style="width: 95px;" onclick="impri_gana_perdida('<? echo $accesogp; ?>');">Ver
                    Reporte</button>
            </th>
        </tr>
    </table>
