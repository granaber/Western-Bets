...
<div id="box6" style="width:500px; background:#0066CC">
  <?php
  ...
  <table width="440" border="0" cellspacing="0">
    <tr>
      <th></th>
      <th colspan="4">
        <div align="center" class="Estilo4d1">Reporte Resumido de Tablas x Grupos</div>
        <div align="right"></div>
      </th>
    </tr>
    <tr>
    ...
    <tr>
      <th></th>
      <th>
        <div align="right" class="Estilo3d1" style="display:none">Clasificar Por:</div>
      </th>
    ...
    <tr>
      <th></th>
      <th class="Estilo3d1" style="display:none">
      ...
      <th colspan="2">
        <span id="spryselect1">
          <label>
            <div id="tdc" align="left" style="display:none">
    ...
    <tr>
      ...
      <th width="80">&nbsp;</th>
      <th colspan="2">&nbsp;</th>
      <th width="68"><input name="" type="button" onclick="impri_resumidogrupos_tablas(<? echo $accesogp; ?>);" value="Imprimir Reporte" />&nbsp;&nbsp;</th>
    </tr>
  </table>
</div>
