...
function formatoticket(se) {
  ...
  new Ajax.Request("procierre.php?op=4&serial=" + se, {
    ...
    onComplete: function (transport) {
      ...
      a +=
      '<tr style="background: #ccc;height: 10px;"><th colspan="3" scope="col"><p align="left"></p></th></tr><tr><th colspan="2" scope="col" style="font-weight: bold;">APUESTA:</th><th scope="col" ><p align="right">' +
        valoreex[5] +
        valoreex[2] +
        '</p></th> </tr><tr><th colspan="2" scope="col" style="font-weight: bold;">A Cobrar:  </th> <th scope="col" ><p align="right">' +
        valoreex[5] +
        valoreex[3] +
        '</p></th> </tr>  <tr><th colspan="2" scope="col" style="font-weight: bold;" >Su Ganacia:</th><th scope="col"><p align="right">' +
        valoreex[5] +
...
function initMenu(_Autorizados) {
  ...
  new Ajax.Request("xmlcreaterMenu.php", {
    parameters: { file: archivo, Autorizados: _Autorizados },
    method: "post",
    asynchronous: false,
    onComplete: function (transport) {
      var response = transport.responseText;
  ...
  menu = new dhtmlXMenuObject("contextArea", "modern_black");
    ...
    if (tg.nodeName === ELEMENT_TH && tg.id === "") {
      ...
      child.forEach(o => {
        ...
        if (setDisable) {
          ...
          if (type === INPUT_TYPE) {
            resul[position - 1] = myObj.value === "" ? "*" : myObj.value
          }
...
function handleChangeRecordGroup(idbanca,accesogp) {
  new Ajax.Request(`verjugadaxml-group.php?idb=${idbanca}&accesogp=${accesogp}`, {
    method: 'get',
    asynchronous: false,
    onComplete: function(e) {
      var html = e.responseText
      $('divgrupos').innerHTML = html
