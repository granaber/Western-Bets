    ...
    <table width="575" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr bgcolor="<?php echo $row["Color"] ?>">
        <th colspan="17" align="left" valign="middle" scope="col"><?php if ($idc == '-2' || $idc == '-1') : ?> Concesi.:
            <input id="cons" type="text" size="10" maxlength="10" onkeyup="this.value = this.value.toUpperCase();validar_con_ju(event,4);pulsart(event,'nom');" onfocus="$('nom').disabled='disabled';  for (iii=1;iii<=parseInt($('carr').title);iii++) {  $('v'+iii).disabled='disabled';	}" onchange="" />
      ...
      <tr bgcolor="<?php echo $row["Color"] ?>">
        ...
        <th id="multi" width="127" align="left" valign="middle" scope="col" title="<?php echo $row["Multip"]; ?>">
      ...
      <tr>
        ...
        for ($i = 1; $i <= $cantcarr; $i++) {
          ...
          echo '<th width="30" bgcolor="#FFFFFF" scope="col"> <input type="text" id="v' . $i . '" size="3"  onkeypress="return permite(event, ' . $ty . ');"  onkeyup = "pulsartcl(event,' . $g . ');" ' . $tcx . '  /></th>';
