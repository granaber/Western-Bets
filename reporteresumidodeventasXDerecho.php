...
<div id="box12" style="width:480px">
    <?php
    ...
    <table border="0" cellspacing="0" style="line-height: 22px;">
        <tr bgcolor="#333333">
            ...
            <th colspan="4" bgcolor="#333333">
                <div align="center" class="Estilo4d1">Reporte de Ventas y Ganacias Resumido por Fecha (JUGADA POR
                    DERECHO)</div>
                <div align="right"></div>
            </th>
        </tr>
        ...
        <tr bgcolor="#333333">
            ...
            <th width="68" bgcolor="#333333">
                <button class="button-pv-standard" style="width: 95px;" onclick="imprimirreddxDerecho()">Ver
                    Reporte</button>
            </th>
        </tr>
    </table>
