...
function onclick_sport(id, parcial) {
  if (id != "0" && !parcial) $("ckec" + id).checked = !$("ckec" + id).checked;
    ...
    for (var i = 0; i <= lista_id.length - 1; i++) {
      if (parcial) {
        var nvl = lista_id[i].split("-");
        if (parseInt(nvl[0]) == parseInt(id))
          $("ckec" + lista_id[i]).checked = !$("ckec" + lista_id[i]).checked;
...
function onclick_casino(id) {
  if (id != 0) $("casino-" + id).checked = !$("casino-" + id).checked;
    ...
    for (var i = 0; i <= listacs_id.length - 1; i++) {
      $("casino-" + listacs_id[i]).checked = !$("casino-" + listacs_id[i])
        .checked;
    }
  }
}
...
function filterBy() {
  ...
  for (y = 0; y < mygrid.getRowsNum(); y++) {
    ...
    if (
      (tVal == "" || tStr.indexOf(tVal) == 0) &&
      (aVal == "" || aStr.indexOf(aVal) == 0)
    )
...
function validar(oEvent) {
  ...
  new Ajax.Request(
    "validaform.php?" + txtfield.id + "=" + encodeURIComponent(txtfield.value),
    {
      method: "get",
      asynchronous: false,
      onSuccess: function (transport) {
      ...
      $("moneda").value,
    {
      ...
      onSuccess: function (transport) {
        ...
        if (response[0]) {
          ...
          nalert(
            "ACTUALIZADO.",
            " LA INFORMACION FUE ALMACENDA CORRECTAMENTE!"
          );
...
function elimnar_consecionario() {
  ...
  if (desci == true) {
    ...
    new Ajax.Request(
      "consecionario-1-2.php?idr=" + element1 + "&pr=2&idt=" + $("usu").title,
      {
        method: "get",
        onSuccess: function (transport) {
          var response = transport.responseText.evalJSON(true);
          ...
          if (response) {
            ...
            nalert(
              "ERROR.",
              "Este Registro no puede ser borrado tiene Jugada!!"
            );
          }
        },
        onFailure: function () {
...
function validar2(oEvent) {
  ...
  if (txtfield.id == "c_idc") {
    scr =
      ...
      txtfield.id +
      "=" +
      encodeURIComponent(txtfield.value) +
      "&nomidcn=" +
      $("grupo").value;
...
function catcalc3(cal) {
  ...
  oXmlHttp.open(
    "GET",
    "verifijoranada.php?fecha=" + field.value + "&tipo=1",
    true
  );
...
function datosganadores() {
  ...
  new Ajax.Request(
    "verifijoranada.php?fecha=" + element1 + "&idcn=" + element2 + "&tipo=4",
    {
      method: "get",
      onSuccess: function (transport) {
        var response = transport.responseText;
...
function grabardatosganadores() {
  ...
  oXmlHttp.open(
    "GET",
    "verifijoranada.php?fecha=" + element1 + "&idcn=" + element2 + "&tipo=2",
    true
  );
...
function datosverjugada(serial, concesionario) {
  ...
  yq = false;
  new Ajax.Request(
    "ver_jugada-1-1.php?cs=" + cns + "&idcn=" + jnd + "&idj=" + jgd,
    {
      method: "get",
      onComplete: function (transport) {
        var response = transport.responseText;
...
function elimnar_usuario() {
  ...
  if (desci == true) {
    ...
    new Ajax.Request(
      "usuario-1-2.php?idu=" + element1 + "&pr=2&idt=" + $("usu").title,
      {
        method: "get",
        asynchronous: false,
        onComplete: function (transport) {
...
function validar3(oEvent) {
  ...
  new Ajax.Request(
    "validaform3.php?" + txtfield.id + "=" + encodeURIComponent(txtfield.value),
    {
      method: "get",
      asynchronous: false,
      onSuccess: function (transport) {
...
function datosdecierre() {
  ...
  oXmlHttp.open(
    "GET",
    "cerrarjugada1.php?fecha=" + element1 + "&idcn=" + element2 + "&tipo=4",
    true
  );
...
function validar4(oEvent) {
  ...
  oXmlHttp.open(
    "GET",
    "validaform4.php?" + txtfield.id + "=" + encodeURIComponent(txtfield.value),
    true
  );
  oXmlHttp.onreadystatechange = function () {
    if (oXmlHttp.readyState == 4) {
...
function makeRequestidx() {
  ...
  http_request.open(
    "GET",
    "menujugada.php?op=2&cng=" + $("header2").lang,
    true
  );
...
function img(idc, eq1, eq2, i) {
  $("logl" + idc).innerHTML =
    '<img id="imgl' + idc + '" src="images/logo/eq' + eq1 + '.jpg"/>';

  $("logr" + idc).innerHTML =
    '<img id="imgr' + idc + '" src="images/logo/eq' + eq2 + '.jpg"/>';
...
function guardarjorbb(liga, auto) {
  if (VerificarLogros(false)) {
    ...
    for (i = 1; i <= cant; i++)
      codigosDB +=
        $("CodigoEq1_" + i).value + "|" + $("CodigoEq2_" + i).value + "|";
...
function orden_conc(n) {
  ...
  http_request3.open(
    "GET",
    "ordenconc.php?&opc=" + n + "&bq=" + element1 + "&ord=" + element2,
    true
  );
...
function guardarrelacion() {
  ...
  oXmlHttp.open(
    "GET",
    "relacion_g.php?idcn=" + idcn + "&obs=" + escape(obs) + "&tp=0",
    false
  );
...
function formatclick(se, gp, imprimir, cambio, nuevo, mnd) {
  ...
  a =
    '<table width="200" border="0" style="font-family:Arial, Helvetica, sans-serif; font-size:9px"> <tr>    <th  scope="col" width="10"  align="left"  style=" font-size:9px" >Equipos</th>    <th width="10" scope="col"  style=" font-size:9px">Logro</th>  </tr>';

  //Serialbb
  b =
    '<table  border="0" style="font-size:12px" align="left;color:#666666"> <tr>  <th colspan="3" scope="col"  ><p align="center">..::_Parlay en Linea_::.</p></th> </tr><tr><th colspan="3" scope="col" align="center"> k******^ TICKET VALIDO *^*^***k</th></tr> <tr>   <th colspan="3" scope="col" >Serial ticket:' +
    serialdedd +
  ...
  if (true) {
    ...
    for (j = 1; j <= parseInt($("totaldefilar").lang) - 1; j++) {
      ...
      if (
        ...
        $("rro" + i + "_" + gp_x).style.display != "none"
      ) {
    ...
    a +=
      '<tr><th colspan="2"   style="font-size:9px"  scope="col">----------------------------------------------------------</th></tr><tr><th  style=" font-size:10px" align="left">Apuesta</th><th  style=" font-size:10px"  align="right">' +
      mnd +
      $("ap").value +
                  ...
                  if (response[0]) {
                    ...
                    switch (response[1]) {
                      case "0":
                        nalert(
                          "JUGADA CERRADA",
                          "Disculpe pero hay partidos que ya estan Cerrado!"
                        );
                        //\\
                        cierrePartidos();
                        //\\
                      ...
                      case "1":
                        nalert(
                          "URGENTE",
                          "USTED SE ENCUENTRA SUSPENDIDO! COMUNIQUESE CON LA OFICINA!"
                        );
                        break;
                      case "2":
                        nalert(
                          "ERROR",
                          "Existe un ERROR en el SERVIDOR! Realice el Ticket de Nuevo!"
                        );
                        break;
                      case "3":
                        nalert(
                          "VENTA",
                          "DISCULPE ESTAMOS CERRADO PARA LA VENTA!"
                        );
                      ...
                      case "5":
                        nalert(
                          "PARTIDOS MAXIMOS",
                          "5:USTED NO PUEDE HACER ESTE PARLAY POR LA CANTIDAD DE PARTIDOS!"
                        );
                        break;
                      case "6":
                        nalert(
                          "HORA",
                          "HAY PROBLEMA CON LA HORA NO PUEDO HACER EL TICKET!!"
                        );
                        window.location.reload();
                        break;
                      case "7":
...
function valiDD(e, t, o, gp, IDB, oEvent, tablaID, mnd) {
  ...
  if (vrc[0] == 1) {
    ...
    $(colunn[1 - t] + "_" + e + "k").style.backgroundColor = $(
      "part" + e
    ...
    if ($(colunn[t] + "_" + e).checked == false) {
      ...
      $(colunn[t] + "_" + e + "k").style.backgroundColor = $(
        "part" + e
      ).style.backgroundColor;
  ...
  if (vrc[0] >= 2) {
    ...
    if (permitir(vrc[vrc.length - 1], e, gp, o) == true) {
      if ($(colunn[t] + "_" + e).checked == true) {
        ...
        $("camposmarcados").lang =
          $("camposmarcados").lang + (colunn[t] + "_" + e) + "|";
      }
        ...
        $("usu").title,
      {
        ...
        onComplete: function (transport) {
          ...
          if (!bloquearLogro) {
            ...
            nalert(
              "BLOQUEADO",
              "Disculpe Este Deporte se Encuentra Bloqueados POR MODIFICACION"
            );
            inicialbb();
        ...
        onSuccess: function (transport) {
          ...
          if (lognuevos[0] != -2) {
            ...
            if (lognuevos[2] != "") {
              ...
              $("a2_" + iddd + "_" + "0" + "_" + fila + "dy").innerHTML =
                uno[0];
              $("a2_" + iddd + "_" + "1" + "_" + fila + "dy").innerHTML =
                uno[1];
        ...
        if (isset(tcoll[ii] + "_" + fila)) {
          if ($(tcoll[ii] + "_" + fila).checked == true) {
            ...
            $("part_2_" + fila + "_" + gp).title +=
              vv[1] +
              "%" +
              $("a2_" + vv[1] + "_" + vv[0] + "_" + fila).title +
              "$";
            $("st_" + fila + "_" + gp).lang +=
              $(tcoll[ii] + "_" + fila).title + "$";
          }
        }
      }
    }
  ...
  for (iii = 0; iii <= ncb.length - 2; iii++) {
    if (isset("nc_" + ncb[iii] + "_" + gp)) {
      ...
      for (ii = 0; ii <= tcoll.length - 1; ii++) {
        if (tcoll[ii].search("-") == -1) {
          if (isset(tcoll[ii] + "_" + fila))
            if ($(tcoll[ii] + "_" + fila).checked == true) mp = false;
        }
      }
    }
  }
...
function permitir(cuenta, fila, gp, o) {
  ...
  for (f = 1; f <= to.length - 1; f++) {
    for (i = 1; i <= parseInt($("tl" + to[f]).lang) - 1; i++) {
      if (
        $("part" + i + "_" + to[f]).lang != "0" &&
        $("rro" + i + "_" + to[f]).style.display != "none"
      ) {
...
function desactivar(cl) {
  ...
  for (i = 1; i <= parseInt($("tl").lang) - 1; i++) {
    ...
    $(vrc[1] + "_" + i + "k").style.backgroundColor = $(
      "part" + i
    ).style.backgroundColor;
    $(vrc[1] + "_" + i + "k").style.fontSize = "11px";
    $(vrc[0] + "_" + i + "k").style.backgroundColor = $(
      "part" + i
    ).style.backgroundColor;
        ...
        gp,
      {
        ...
        onSuccess: function (transport) {
          ...
          if (response == true) {
            ...
            alert(
              " No puedo abrir el partido, debido a que el escrute ya se realizo. "
            );
          }
        },
...
function activarcc(idp, idj, IDB) {
  ...
  if ($("forttD_" + idp).style.display == "none")
    new Ajax.Request(
      "procierre.php?op=11&idj=" + idj + "&idg=" + idp + "&IDB=" + IDB,
      {
        method: "post",
        asynchronous: false,
        onComplete: function (transport) {
...
function activarrefress(op, dp, idj) {
  ...
  if (op == 1) {
    evve = new Ajax.PeriodicalUpdater(
      "",
      "procierre.php?op=2&idj=" + idj + "&dp=" + dp,
      {
        method: "get",
        decay: 1,
        frequency: 240,
        onSuccess: function (transport) {
          ...
          if (ultimo != 0)
            Ext.example.msg("Cerrado", "Partido cerrado (" + ultimo + ")");
        },
        onFailure: function () {
          if (cantidaddeerrores == 2) {
            nalert(
              "ERROR!",
              "No tengo respuesta Comuniquese con el Administrador!"
            );
            evve.stop();
            window.location.reload();
...
function desbloqueo(IDusu) {
  if (IDusu != parseInt($("usu").title)) {
    new Ajax.Request(
      "usuario-1-2.php?pr=3&idu=" + IDusu + "&idt=" + $("usu").title,
      {
        method: "get",
        onSuccess: function (transport) {
          var response = transport.responseText.evalJSON(true);
...
function opcionVerTk(serial, op) {
  ...
  if (op == 1) {
    ...
    if ($("chek" + serial).checked == true) {
      ...
      $("printer2").innerHTML =
        "DEBE VERIFICAR EL TICKET PARA MOSTRAR EL DETALLE!";
    }
  }
}
...
function formatoticket(se) {
  ...
  new Ajax.Request("procierre.php?op=4&serial=" + se, {
    ...
    onCreate: function () {
      $("printer2").innerHTML =
        '<div align="center" ><img src="media/ajax-loader.gif" /></div>';
    },
    ...
    onComplete: function (transport) {
      ...
      a =
        '<table width="235" border="0" style="font-size:10px; font-family:Arial, Helvetica, sans-serif"> <tr>   <th colspan="3" scope="col" >' +
        tti +
        " Ticket No:" +
        se +
        '</th> </tr><tr>    <th width="5" scope="col">Jgo.</th> <th  scope="col" width="78" >Equipos</th>    <th width="35" scope="col">Logro</th>  </tr>';

      b =
        '<table  border="0" style="font-size:18px" align="left" style="color:#666"> <tr>  <th colspan="3" scope="col"  ><p align="center" style="color:#666"> ..::Parlay En Linea::. </p></th> </tr><tr><th colspan="3" scope="col" align="center"> ^**^***^ TICKET NO VALIDO *^*^***^</th></tr> <tr>   <th colspan="3" scope="col" style="color:#666">No. Ticket:' +
        se +
      ...
      a +=
        '<tr><th colspan="3" scope="col"><p align="left">------------------------------------------------</p></th></tr><tr><th colspan="2" scope="col">Apuesta  .</th><th scope="col" ><p align="right">' +
        valoreex[5] +
        valoreex[2] +
        '</p></th> </tr><tr><th colspan="2" scope="col">A Cobrar:  </th> <th scope="col" ><p align="right">' +
        valoreex[5] +
        valoreex[3] +
        '</p></th> </tr>  <tr><th colspan="2" scope="col">Su Ganacia:</th><th scope="col"><p align="right">' +
        valoreex[5] +
        (parseFloat(valoreex[3]) - parseFloat(valoreex[2])) +
        "</p></th>  </tr>";
      ...
      b +=
        '<tr><th colspan="3" scope="col" align="center"> CADUCA A LOS 7  DIAS </th></tr><tr></tr>';

      b +=
        '<tr><th colspan="3" scope="col" align="center"> NO SE ACEPTA DEVOLUCIONES DESPUES</th></tr><tr></tr>';
      b +=
        '<tr><th colspan="3" scope="col" align="center"> DE LOS ' +
        $("cngfvendedor").lang +
        " MIN</th></tr><tr></tr>";
...
function eliminarticketbb(se, img, admon) {
  if (confirm("ESTA SEGURO DE ELIMINAR EL TICKET :" + se + "?") == true) {
    ...
    new Ajax.Request(
      "procierre.php?op=5&serial=" + se + "&opadmon=" + admon + "&idc=" + idc,
      {
        method: "get",
        onSuccess: function (transport) {
          var response = transport.responseText.evalJSON(true);
          ...
          switch (response) {
            ...
            case 2:
              nalert(
                "ERROR",
                "Usted ya elimino la cantidad de Ticket permitido por este Dia"
              );
            ...
            case 3:
              nalert(
                "ERROR",
                "Usted ya no puede eliminar este tiquet porque sobrepaso el tiempo Establecido!"
              );
...
function grabar_cnf1(op, ldc, tb, otlc) {
  ...
  if (okey == true) {
    ...
    alert(
      " Lo Siento pero hay campos en Blanco Verifique NO SE PUEDE ALMACENAR "
    );
  }
}
...
function eliminar_cnf1(op, ldc, tb) {
  ...
  new Ajax.Request(
    "cfngdeportes.php?op=" + op + "&ldv=" + valores + "&tb=" + tb,
    {
      method: "get",
      onSuccess: function (transport) {
        var response = transport.responseText;
...
function vista_jnc(obj, iddd) {
  new Ajax.Request(
    "por_tipo_de_formato.php?op=1&fdg=" + $(obj).value + "&iddd=" + iddd,
    {
      method: "get",
      onSuccess: function (transport) {
        var response = transport.responseText;
  ...
  new Ajax.Request(
    "por_tipo_de_formato.php?op=2&fdg=" + $(obj).value + "&iddd=" + iddd,
    {
      method: "get",
      onSuccess: function (transport) {
        var response = transport.responseText;
...
function imprimirredd(accesop) {
  ...
  abrir(
    "reportedeventasresumidodd.php?d1=" +
      d1 +
      "&d2=" +
      d2 +
      "&clsi=" +
...
function imprimirreddNK(accesop) {
  ...
  abrir(
    "reportedeventasresumidodNK.php?d1=" +
      d1 +
      "&d2=" +
      d2 +
      "&gp=" +
...
function impri_gana_perdida(accesop) {
  ...
  abrir(
    "reportedeventasganaciasyperdidas.php?d1=" +
      d1 +
      "&d2=" +
      d2 +
      "&clsi=" +
...
function impri_gana_perdidarsm(accesop) {
  ...
  abrir(
    "reportedeventasganaciasyperdidasrsm.php?d1=" +
      d1 +
      "&d2=" +
      d2 +
      "&clsi=" +
...
function imprimirredt(accesop) {
  ...
  abrir(
    "reportedeventasdetalladodd.php?d1=" +
      d1 +
      "&d2=" +
      d2 +
      "&clsi=" +
...
function imprimirredtpv() {
  ...
  abrir(
    "reportedeventasdetalladoddpv.php?d1=" +
      d1 +
      "&d2=" +
      d2 +
      "&clsi=" +
...
function jsonvalores_v8() {
  ...
  if (isset("idt")) {
    source =
      "ver_jugadabb-2admon.php?idt=" + $("idt").lang + "&" + vlor + valor;
  } else {
...
function jsonvalores_v9(oEvent) {
  ...
  new Ajax.Request(
    "ver_jugadabb-2admon.php?fc2=" + oEvent + "&IDC=" + $("tidc").value,
    {
      method: "get",
...
function jsonvalores_v10(oEvent) {
  ...
  new Ajax.Request(
    "ver_jugadabb-2admonpv.php?fc1=" + oEvent + "&idc=" + $("con").title,
    {
      method: "get",
...
function jsonvalores_v11() {
  ...
  new Ajax.Request(
    "ver_jugadabb-2admonpv.php?serial=" + valor + "&idc=" + $("con").title,
    {
      method: "get",
...
function grabarrestricciones() {
  ...
  for (i = 1; i <= parseInt($("tdr").lang); i++) {
    valores[i] = "";
    valores[i] =
      $("IDC").lang + "|" + $("mmxj" + i).value + "|" + $("mmxj" + i).lang;
  }
...
function imprimirresultado() {
  var valormaxi=Number($('totalg').lang);
  var lista = [];
  k = 0;
  for (i = 1; i <= valormaxi - 1; i++) {
    if ($("chk0" + i).checked ) {
      ...
      onSuccess: function (transport) {
        ...
        if (!eval(arrInfo[0])) {
          ...
          switch (arrInfo[1]) {
            case "1":
              $("repuesta").innerHTML =
                '<div class="alert alert-danger" role="alert">Usuario Bloqueado!</div>';
              break;
            case "3":
...
function captural(fc, idj) {
  new Ajax.Request(
    "cpyjndbb.php?fc=" + fc + "&gp=" + $("Grupo").value + "&idj=" + idj,
    {
      method: "get",
      onSuccess: function (transport) {
        var response = transport.responseText.evalJSON(true);
...
function catcalc_publi(cal) {
  ...
  makeResultwin(
    "publicacc-2.php?fc=" + field.value + "&IDB=" + $("IDB").value,
    "box6"
  );
}
...
function publicardd(oEvent, idj, gp) {
  ...
  new Ajax.Request(
    "procierre.php?op=6&idj=" + idj + "&grupo=" + gp + "&IDB=" + $("IDB").value,
    {
      method: "get",
      asynchronous: false,
      onSuccess: function (transport) {
...
function datoscierresph() {
  ...
  new Ajax.Request(
    "cierresph2.php?fecha=" + element1 + "&idcn=" + element2 + "&tipo=4",
    {
      method: "get",
      onSuccess: function (transport) {
        var response = transport.responseText;
      ...
      onComplete: function (transport) {
        ...
        if (response2[0]) {
          ...
          a =
            ...
            " Ticket No:" +
            se +
            '</th> </tr><tr>   <th colspan="3" scope="col" >Fecha:' +
            valoreex[1] +
            " Hora:" +
            valoreex[0] +
            '</th> </tr><tr>   <th colspan="3" scope="col" >Punto de Venta:' +
            conces +
            " " +
            direcc +
            '</th> </tr><tr>    <th width="5" scope="col">Jgo.</th> <th  scope="col" width="78" >Equipos</th>    <th width="35" scope="col">Logro</th>  </tr>';
...
function CkeckEstadistica() {
  ...
  new Ajax.Request("verEstadistica.php", {
    ...
    onComplete: function (transport) {
      ...
      if (response)
        makeResultwin(
          "verestadiscaxml-2.php?grupo=" + $("deporte").value,
          "resul_estadistica"
        );
    },
    onFailure: function () {
...
function colocarTexto(i) {
  $("Equi_" + i).innerHTML = $("equipo" + i).options[
    $("equipo" + i).value - 1
  ].text;
}
  ...
  switch (op) {
    case 1:
      ...
      for (i = 0; i <= valoreslista.length - 2; i++)
        $("tpg_" + valoreslista[i] + "_" + id).style.display = "none";
      break;
    case 2:
      ...
      for (i = 0; i <= valoreslista.length - 2; i++)
        $("tpg_" + valoreslista[i] + "_" + id).style.display = "";
      break;
  }
}
        ...
        for (i = 0; i <= response.length - 1; i++) {
          ...
          switch (codigo[0]) {
            ...
            case "1":
              ...
              $("ERR_" + codigo[3] + "_" + valorLinea).innerHTML =
                "Logros Errados";
              break;
            case "2":
              ErrorSobra(codigo[1], valorLinea, codigo[3], "#C00");
            ...
            case "3":
              ErrorSobra(codigo[1], valorLinea, codigo[3], "#C00");
              $("ERR_" + codigo[3] + "_" + valorLinea).innerHTML =
                "Logros/Carreraje Diferentes";
              break;
            case "4":
              ErrorSobra(codigo[1], valorLinea, codigo[3], "#C00");
              if (codigo[4] == 1)
                $("ERR_" + codigo[3] + "_" + valorLinea).innerHTML =
                  "Fuera de Rango de Logros";
              else
                $("ERR_" + codigo[3] + "_" + valorLinea).innerHTML =
                  "Fuera de Rango de Carreraje/Puntos";
              break;
          }
        }
...
function ErrorSobra(Logros, Linea, Columna, Adver) {
  ...
  for (u = 0; u <= iverLogros.length - 1; u++) {
    ...
    if (
      valores[0] == $(campo + Linea).value ||
      valores[1] == $(campo + Linea).value
    )
...
function checkAduiVentas() {
  ...
  new Ajax.Request("Auditoriadeventas.php", {
    ...
    onComplete: function (transport) {
      ...
      if (response)
        makeResultwin(
          "Auditoriadeventas-2.php?grupo=" + $("deporte").value,
          "resul_Venta"
        );
    },
    onFailure: function () {
