...
function grabar_datosJuego()	
	...
	function elimnar_datosJuego()
	 ...
	 {   		   
			 ...
			 new Ajax.Request('consecionario-1-2.php?idc='+element1+'&nm='+element2+'&dr='+element3+'&est='+element4+'&mup='+element5+'&tel='+element6+'&idg='+element7+'&es='+element8+'&idr='+element9+'&pr=1&cel='+ element10+'&mail='+element11+'&resp='+ element12,{ method:'get',onSuccess: function(transport){	
...
var novalido2=true;	
	...
	*/
	        ...
	        if ($('tipo').value==4){
			 ...
			 new Ajax.Request('usuario-1-2.php?us='+element1+'&nm='+element2+'&clv='+element3+'&est='+element4+'&tp='+element5+'&as='+element6+'&es='+element7+'&idu='+element8+'&pr=1&ta='+element9+'&v='+valores+'&v2='+valoressm+'&agrupo='+valor+'&abanca='+valor2,{					method:'get',asynchronous:false	,onComplete: function(transport){
								var response = transport.responseText.evalJSON(true);
								if (response[0]){
	...
	function elimnar_usuario(){  
			 ...
			 new Ajax.Request('usuario-1-2.php?idu='+element1+'&pr=2',{method:'get',asynchronous:false	,onComplete: function(transport){
								var response = transport.responseText.evalJSON(true);
								dhxWins1.window("w1").close();dhxWins1.window("w2").close();
								if (response[0])									
	...
	function grabar_grupo(){  
			...
			new Ajax.Request('grupo-1-2.php?nm='+element1+'&res='+element2+'&tlf='+element3+'&dr='+element4+'&es='+element5+'&idg='+element6+'&pr=1&participa='+$("Participacion").value+'&IDB='+$("IDB").value,{method:'get',asynchronous:false	,onComplete: function(transport){
								var response = transport.responseText.evalJSON(true);
	...
	function tick(url,idp)
		...
		function guardarjorbb(){	
			...
			//new Ajax.Request('jornadabb-1-2.php',{parameters:{'idc':element1,'lista':elemd,'fc':element2,'eq':equip,'hr':hrx},
	
		
	new Ajax.Request('jornadabb-1-2.php?op=1&idc='+element1+'&lista='+elemd+'&fc='+element2+'&eq='+equip+'&hr='+hrx+'&cant='+element5+'&p='+pch+'&gp='+gp+'&e='+efec+'&dp='+$('Grupo').lang+'&np='+np+'&IDB='+$('IDB').lang,{				 
...
{    
  ...
  var txtfield = oEvent.target || oEvent.srcElement;	
	...
	//Serialbb
		...
		{  
			...
			if ($("part"+i+'_'+gp_x).lang!=0 && $("rro"+i+'_'+gp_x).style.display!='none'){ 
				  ...
				  b+='<tr><th align="left">'+$("part_2_"+i+'_'+gp_x).innerHTML+'</th><th align="left">'+nvs_pl+'</th><th align="right" >'+de+'</th></tr>';
	...
	b+='<tr><th colspan="3" scope="col" align="center"> EN CASO DE RECLAMOS PARA EL PAGO </th></tr><tr><th colspan="3" scope="col" align="center"> DE ESTE TICKET COMUNIQUESE  </th></tr><tr><th colspan="3" scope="col" align="center"> AL TELEFONO: 0426-567.6353  </th></tr>';
		$("printer2").lang=lista;
		...
		$("printer").innerHTML=b+'<th>Segurida:</th> <th colspan="2">'+se+'</th> </tr><tr><th colspan="3" scope="col" align="center"> ****** VERIFIQUE SU JUGADA *****</th></tr><tr><th colspan="3">-</th></tr>		<tr><th colspan="3">-</th></tr>		<tr><th colspan="3">-</th></tr>		<tr><th colspan="3">-</th></tr><tr><th colspan="3">-</th></tr><tr><th colspan="3">-</th></tr><tr><th colspan="3">-</th></tr></table>';
	...
	function impticketbb(){               
				...
				/*alert(parseInt($("ap").value));	
	alert(parseInt($("ap").value,10));*/
				...
				if (Number($("ap").value)!=0 )	
					...
					new Ajax.Request("frestricciones.php?op=1&conce="+idc+"&idj="+idj+"&equic="+mpe+"&cantidad="+tte+"&idddc="+idddc+"&jgd="+tdj,{
								method:'get',asynchronous:false,	onSuccess: function(transport){
								var response = transport.responseText.evalJSON(true) ;	
								if (response[0]==false)
								{   
									...
									if(parseInt($("ap").value,10)<=response[2] && estatus==true)
	 								{
									estatus=true;								
									}else{
									  if (estatus==true){
										alert('El Monto Apostado es Mayor al Permitido ');
										estatus=false;
										}
									}			
				 ...
				 {
					new Ajax.Request("frestricciones.php?op=2&conce="+idc+"&idj="+idj+"&equic="+lequi+"&cantidad="+tte+"&idddc="+liddd+"&ap="+$("ap").value+"&acobrar="+valorini,{
								...
								var response = transport.responseText.evalJSON(true);
								  ...
								  if (response[0]==false) {	
									...
									{	
								  	...
								  	if (response[1]=='A') {
										estatus=false;
										alert('La apuesta que usted ha seleccionado, ha sobrepasado el Monto del Premio Permitido!');		
										}
								  }
	       ...
	       if (estatus){
				new Ajax.Request("frestricciones.php?op=3&conce="+idc+"&idj="+idj+"&equic="+lequi+"&cantidad="+tte+"&idddc="+liddd+"&ap="+$("ap").value+"&acobrar="+valorini,{
					...
					//   alert("grabarjugadabb.php?op=1&serial="+Serialbb+"&jgd="+$("printer2").lang+"&ap="+$("ap").value+"&aco="+valorini+"&idj="+idj+"&usu="+IDusu+"&termi="+terminal+"&idc="+idc+'&grp=0');      Serialbb=getCookie('ticket_bb_sn');
						 ...
						 new Ajax.Request("grabarjugadabb.php?op=1&serial="+serialdedd+"&jgd="+tdj+"&ap="+$("ap").value+"&aco="+valorini+"&idj="+idj+"&usu="+IDusu+"&termi="+terminal+"&idc="+idc+'&grp=0',{
								method:'get',asynchronous:false,	onSuccess: function(transport){
								var response = transport.responseText.evalJSON(true) ;	
								if (response[0])
								{
									...
									switch (response[1]){
										...
										case '3':
											...
											break;		
										case '4':
											nalert('TOPE MAXIMO','EL MONTO DE LA APUESTA QUE HA COLOCADO NO ESTA PERMITIDA \nCON LA CANTIDAD DE PARTIDOS SELECCIONADOS!')
											break;	
										case '5':
											nalert('PARTIDOS MAXIMOS','USTED NO PUEDE HACER ESTE PARLAY POR LA CANTIDAD DE PARTIDOS!')
											break;	
										case '6':
...
function valiDD(e,t,o,gp,IDB)
	...
	function updatelogro(iddd,fila,cmp,gp,IDB)
	{
	...
	if ($('forttD_'+idg).style.display!='none')//,asynchronous:false
		new Ajax.Request("procierre.php?op=11&idj="+idj+"&idg="+idg+'&IDB='+IDB,{method:'post',	onComplete: function(transport){
									var response = transport.responseText.evalJSON(true) ;
...
/*	if (!bloquearLogro){
		...
		cmpt=sercol.split('|');	
		new Ajax.Request("procierre.php?op=3&idj="+idj+"&idp="+fila+"&iddd="+iddd +"&idg="+idg+'&IDB='+IDB,{
								method:'get',onSuccess: function(transport){
								var response = transport.responseText.evalJSON(true) ;
								lognuevos=response;
								if (lognuevos[0]!=-2)
...
function activarcc(idp,idj,IDB)
	...
	{        
	...
	
		{
			 ...
			 new Ajax.Request("usuario-1-2.php?pr=3&idu="+IDusu,{
...
function ByView(serial,op) 
	...
	b+='<tr><th colspan="3" scope="col" align="center"> DE LOS '+$('cngfvendedor').lang+' MIN</th></tr><tr></tr>';
		...
		$("printer").innerHTML=b+'<th>SEGURIDAD:</th> <th colspan="2">'+valoreex[4]+'</th> </tr><tr><th colspan="3" scope="col" align="center">****** VERIFIQUE SU JUGADA *****</th></tr><tr>- </tr><tr>- </tr><tr>- </tr><tr>- </tr><tr>- </tr><tr>- </tr><tr>- </tr></table>'
...
function eliminar_cnf1(op,ldc,tb)	
	...
	function jsonvalores3(idc){
			 ...
			 new Ajax.Request("jornadabb-1-2.php?op=2&idc="+idc+'&dp='+$('Grupo').value+'&IDB='+$('IDB').value,{	
			 method:'get',asynchronous:false,	
				onComplete: function(transport){
				var response = transport.responseText.evalJSON(true) ;
...
function ImportarLogros()
		 {   
			...
			new Ajax.Request('jornadabb-1-2.php?hasta='+$('fromcambio').lang+'&desde='+$('desde').value+'&op=3',{method:'get',asynchronous:false	,onComplete: function(transport){
								var response = transport.responseText.evalJSON(true);
