...
{    
  ...
  var txtfield = oEvent.target || oEvent.srcElement;	
	...
	//Serialbb
		...
		{  
			...
			if ($("part"+i+'_'+gp_x).lang!=0 && $("rro"+i+'_'+gp_x).style.display!='none'){ 
				  ...
				  //+$(dequi[0]).innerHTML+'-'
				  impresion+='<tr><th align="left">'+$("part_2_"+i+'_'+gp_x).innerHTML+'</th><th align="left">'+nvs_pl+'</th><th align="right" >'+de+'</th></tr>';	
	...
	b1+='<tr><th colspan="3" scope="col" align="center"> No se aceptan devoluciones,Toda apuesta</th></tr><tr></tr>';
    ...
    b1+='<tr><th colspan="3" scope="col" align="center"> para el inicio del evento,Al participar</th></tr><tr></tr>';
