    ...
    <tr>
		...
		if (mysqli_num_rows($result)!=0): 
			...
			while($row3 = mysqli_fetch_array($result))
			{
				...
				while($row2 = mysqli_fetch_array($result2))
					...
					echo '<li class="TabbedPanelsTab" tabindex="0" ><div align="center"  style="color:#000000; font-size:12px"><samp id="c'.$row2['IDDD'].'"/></samp><br /><strong>'.$row3['Descripcion'].'</strong><br /><strong  style="color:#FFCC00">'.$row2['Descripcion'].'</strong></div></li>';
			...
			$cc++;	   
				...
				echo '<li class="TabbedPanelsTab" tabindex="0" ><div align="center"  style="color:#000000; font-size:12px"><br /><strong>Pichers/Efectividad</strong><br /><strong  style="color:#FFCC00">Juegos</strong></div></li>';
		endif;
		echo '</ul><div class="TabbedPanelsContentGroup">';
		 ...
		 $result = mysqli_query($GLOBALS['link'],"SELECT * FROM _formatosbb  where Grupo=".$dp."  Order by Formato" ); 
					   ...
					   for ($i=1;$i<=$cant;$i++){
						...
						{	
							...
							if ($cualv=='' && $row2['logrosxdefecto']!=''):
							   ...
							   if ($ii==0): $cualv=$valoresdd[$ii]; endif;						
							   if (count($col)==4): 
							   	if ($ii==2 ): $cualv=$valoresdd[1]; endif;
							   endif;	
							    if (count($col)==2): 
							   	if ($ii==1): $cualv=$valoresdd[1]; endif;
							   endif;	
							endif;
							//*******************************************************//
		  ...
		  for ($t=0;$t<=count( $listdv);$t++){	echo '<samp id="cv'.$t.'" lang="'.$listdv[$t].'"></samp>';   }
		...
		echo '<samp id="ntc" lang="'.$cc.'"></samp></tr>';
		 ...
		 //  if ($permitirmod): $dis=""; else: $dis="disabled"; endif; 
          ...
          echo ' </div></td><td ><div align="center"><select name="select2" size="1" id="equipo'.$i.'" >';
