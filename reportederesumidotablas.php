...
<div id="box6" style="width:500px; background: #CC9933">
  <?php
  ...
  <table width="440" border="0" cellspacing="0">
    <tr>
      <th></th>
      <th colspan="4">
        <div align="center" class="Estilo4d1">Reporte Resumido de Tablas</div>
        <div align="right"></div>
      </th>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <th width="80">&nbsp;</th>
      <th colspan="2">&nbsp;</th>
      <th width="68"><input name="" type="button" onclick="impri_resumido_tablas(<? echo $accesogp; ?>);" value="Imprimir Reporte" />&nbsp;&nbsp;</th>
    </tr>
  </table>
</div>
