...
while ($Row = mysqli_fetch_array($resultj)) {
  $resultj2n = mysqli_query($link, "Select * from _Banca_Tope_S Where IDS=" . $Row['id']);
  if (mysqli_num_rows($resultj2n) == 0)
    $resultj2n = mysqli_query($link, "Insert _Banca_Tope_S Value (" . $Row['id'] . ",0,0)");
}




$sql = "Select * from _Banca_Tope_S  order by IDS";
//echo $sql;
