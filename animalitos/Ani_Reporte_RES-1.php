    ...
    <table width="475" border="0" cellspacing="0">
        ...
        <tr>
            ...
            <th colspan="3">
                ...
                <label>
                    <input type="radio" name="radio" id="dos_ani" value="radio"
                        onclick="$('tu_ani').style.display='none';$('tdc_ani').style.display='none';$('td_ani').style.display='';$('tdg_ani').style.display='';" />
                </label>
        ...
        switch (id) {
            ...
            case "ImprimiR_":
                ...
                openClas('Ani_Reporte_RES-2.php', 'd1=' + $("fc1_ani").value + "|d2=" + $("fc2_ani").value + "|op=" +
                    clsi1 + "|gp=" + gp + "|iGrupo=<? echo $iGrupo; ?>", 'Reporte de Tickets Pagados', 1, 0, 0, 0, 0, 0,
                    1, 400, 400, 100, 100, 1);
                break;
        }
    }
