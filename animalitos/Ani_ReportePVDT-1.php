...
<div id="fromReporte" style=" height:1000px; background:#999">
	<?php
	...
	<table width="440" border="0" cellspacing="0">
		<tr>
			<th width="1"></th>
			<th colspan="4">
				<div align="center" class="Estilo4d1">Reporte Detallado</div>
				<div align="right"></div>
			</th>
		</tr>
		<tr>
		...
		<tr>
			<th></th>
			<th>
				<div align="right" class="Estilo3d1">Desde:</div>
			</th>
	...
	function clicktoolBar(id) {
		switch (id) {
			case "Cerrar_":
				...
				break;
			case "ImprimiR_":
				openClas('Ani_ReportePVDT-2.php', 'd1=' + $("fc1").value + "|d2=" + $("fc2").value + "|IDC=" + $('con').title, 'Reporte Resumido', 1, 0, 0, 0, 0, 0, 1, 400, 400, 100, 100, 1);
				break;
		}
	}
