...
<div id="fromReporte" style=" height:1000px; background:#699">
    <?php
    ...
    // if ($row['IDusu'] != 0) :
    //     echo "<script> alert('NO TIENE AUTORIZACION!'); </script>";
    //     exit;
    // endif;
    ...
    <table width="475" border="0" cellspacing="0">
        <tr>
            <th width="0"></th>
            <th colspan="4">
                <div align="center" class="Estilo4d1">Reporte de Ventas Detallado</div>
                <div align="right"></div>
            </th>
        </tr>
        <tr>
...
<script>
    ...
    function clicktoolBar(id) {
        switch (id) {
            ...
            case "ImprimiR_":
                ...
                openClas('Ani_Reporte_DET-2.php', 'd1=' + $("fc1_ani").value + "|d2=" + $("fc2_ani").value + "|op=" +
                    clsi1 + "|gp=" + gp + "|iGrupo=<? echo $iGrupo; ?>", 'Reporte de Venta Detallados', 1, 0, 0, 0, 0,
                    0,
                    1, 400, 400, 100, 100, 1);
                break;
        }
    ...
    w1.setText('Reporte de Venta Detallado');
