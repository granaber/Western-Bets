...
while ($Row = mysqli_fetch_array($resultj)) {
  $resultj2n = mysqli_query($link, "Select * from _Banca_Tope_N Where IDS=" . $_REQUEST['id'] . " and numero='" . $Row['num'] . "'");
  if (mysqli_num_rows($resultj2n) == 0)
    $resultj2n = mysqli_query($link, "Insert _Banca_Tope_N Value (" . $_REQUEST['id'] . ",0,0,'" . $Row['num'] . "')");
}




$sql = "Select * from _Banca_Tope_N Where IDS=" . $_REQUEST['id'] . " order by numero";
//echo $sql;
