<?
 ...
 switch($Tipo){
	 case   'MLB':
					$Grupo="INSERT INTO `_gruposdd` (`Grupo`, `Descripcion`, `Estatus`, `imagen`) VALUES($ValorG, '$Descripcion', 1, '$ValorG.png');";
					...
					$Relacion1="INSERT INTO `_tbligaxml` (`Grupo`, `Liga`, `Minutos`) VALUES ('$ValorG', '$Liga', '$minutos');";
					$Relacion2="INSERT INTO `_tblogrosxml` VALUES  ($ValorJ1, $Liga,$Liga, 'voddst|hoddst', 'Game'),(".($ValorJ1+1).", $Liga,$Liga, 'ovoddst|unt|unoddst|unt', 'Game'),(".($ValorJ1+2).", $Liga,$Liga, 'vsprdoddst|vsprdt|hsprdoddst|hsprdt', 'Game');";
		...
		case   'SOC':
					...
					$Relacion1="INSERT INTO `_tbligaxml` (`Grupo`, `Liga`, `Minutos`) VALUES ('$ValorG', '$Liga', '$minutos');";
					$Relacion2="INSERT INTO `_tblogrosxml` VALUES  ($ValorJ1, $Liga,$Liga, 'voddst|hoddst', 'Game'),(".($ValorJ1+1).", $Liga,$Liga, 'ovoddst|unt|unoddst|unt', 'Game'),(".($ValorJ1+2).", $Liga,$Liga, 'vspoddst', 'Game');";
					...
					break;
		case   'CFB':
					$Grupo="INSERT INTO `_gruposdd` (`Grupo`, `Descripcion`, `Estatus`, `imagen`) VALUES($Liga, '$Descripcion', 1, '$Liga.png');";
					...
					$Relacion1="INSERT INTO `_tbligaxml` (`Grupo`, `Liga`, `Minutos`) VALUES ('$ValorG', '$Liga', '$minutos');";
					$Relacion2="INSERT INTO `_tblogrosxml` VALUES  ($ValorJ1, $Liga,$Liga, 'vsprdoddst|vsprdt|hsprdoddst|hsprdt', 'Game'),(".($ValorJ1+1).", $Liga,$Liga, 'ovoddst|unt|unoddst|unt', 'Game'),(".($ValorJ1+2).", $Liga,$Liga, 'voddst|hoddst', 'Game');";					
		...
		case   'MU':
					...
					$Relacion1="INSERT INTO `_tbligaxml` (`Grupo`, `Liga`, `Minutos`) VALUES ('$ValorG', '$Liga', '$minutos');";
					$Relacion2="INSERT INTO `_tblogrosxml` VALUES  ($ValorJ1, $Liga,$Liga, 'voddst|hoddst', 'Game');";					
