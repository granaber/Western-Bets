  <nav class="layout-navbar container-l navbar navbar-expand-l navbar-detached align-items-center <?= $dark ? 'navbar-dark bg-dark' : '  bg-navbar-theme ' ?> "
      id="layout-navbar">
      <div class="layout-menu-toggle navbar-nav align-items-xl-center me-3 me-xl-0 d-l-none">
          <? if ($valores[12] != 'TEST') { ?>
      ...
      <? if ($valores[12] != 'TEST') { ?>
          <div style="display: flex; justify-content: center; align-items: center;">
              <img src="media/logo-bg-intro-offbg.png" alt="" srcset="" style="width: 80%;">
          </div>
      <? } ?>
  ...
  <? if ($valores[12] != 'TEST') { ?>
      <aside id="layout-menu"
          ...
          <div style="background-color:<?= $dark ? 'black' : 'gray' ?> ; margin: auto;" class="app-brand">
              <img width="100%" src="main/image/betgambler_nw.png" alt="" srcset="">
