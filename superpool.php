...
<div align="left">
  ...
  <table width="590" bgcolor="#999999">
    <tr bgcolor="#FFCC33">
      <th colspan="19" align="left" bgcolor="#FFCC00" scope="col"><span id='tj' title="<?php echo $tj; ?>" class="Estilo43">POOL DE SEIS</span></th>
    </tr>
    <tr bgcolor="#FFCC33">
    ...
    <tr>
      <th width="144" rowspan="6" bgcolor="#FFCC33" scope="col">
      ...
      for ($i = 1; $i <= $row["CantidadCarr"]; $i++) {
        ...
        echo '<th width="17" scope="col" bgcolor="#FFCC33" title="' . $cejem . '">' . $i . '.-</th>';
        ...
        echo '<th width="103" bgcolor="#FFCC33" scope="col"></th>';
        echo '</tr>';
      }
      ?>

      <th bgcolor="#FFCC33" scope="row"><label></label></th>
      <th colspan="17" bgcolor="#FFCC33" scope="row"><label> </label>
