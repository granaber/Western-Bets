<div id='tpg2' class='tabPanelGroup'>
	...
	<div id='tpg21' class='tabPanel'>
		<table width="278px" border="0" cellspacing="0" cellpadding="0">
			...
			$result = mysqli_query($GLOBALS['link'], "SELECT * FROM _tdjuegos_escrutehi where IDJug=" . $pfc . " Order by NumeroEje");
			$Y = 1;
			while ($row = mysqli_fetch_array($result)) {
				...
				$campod = "eliminar_cnf1(7,'IDJug=" . $pfc . "|NumeroEje=" . $row['NumeroEje'] . "','_tdjuegos_escrute');makeResultwin('agregarjuego-1-3hi.php?idjug=" . $pfc . "','esc');";
