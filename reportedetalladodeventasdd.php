...
<div id="box12" style="width:450px">
    <?php
    ...
    <table border="0" cellspacing="0" style="line-height: 22px;">
        <tr bgcolor=" #333333">
            ...
            <th colspan="4" bgcolor="#333333">
                <div align="center" class="Estilo4d1">Reporte de Ventas y Ganacias Detallado por Fechas</div>
                <div align="right"></div>
            </th>
        </tr>
        <tr bgcolor="#333333">
        ...
        <tr bgcolor="#333333">
            ...
            <th width="144" bgcolor="#333333"><input class="input-pv-standard" name="fc" type="text" id="fc1" size="10" value="<?php echo date("d/n/Y"); ?>" /></th>
            <th width="137" bgcolor="#333333">
                <div align="right" class="Estilo3d1">Hasta:</div>
            </th>
            <th bgcolor="#333333"><input class="input-pv-standard" name="fc" type="text" id="fc2" size="10" value="<?php echo date("d/n/Y"); ?>" /></th>
        </tr>
        ...
        <tr bgcolor="#333333">
            ...
            <th colspan="2" bgcolor="#333333">&nbsp;</th>
            <th width="68" bgcolor="#333333">
                <button class="button-pv-standard" style="width: 95px;" onclick="imprimirredt('<? echo $accesogp; ?>');">Ver
                    Reporte</button>
            </th>
        </tr>
    </table>
