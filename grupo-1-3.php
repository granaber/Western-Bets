...
$IDB=$_REQUEST['IDB']; //$formato=$_REQUEST['frm'];
//if ($IDG==0):
//	$grid->event->attach("beforeRender","formatting");
	$grid->render_sql("SELECT * FROM _tgrupo Where IDB=$IDB","IDG" ,"IDG,Descrip,Responsable,Estatus");
 ...
 /*function my_update($data){
	  ...
	  function formatting($row){
				...
				switch ($row->get_value("Tipo")){
					...
					case 4:$row->set_value("Tipo",'Admin.Grupo'); break;
