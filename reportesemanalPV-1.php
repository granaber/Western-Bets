...
<div id="fromReporte" style=" height:1000px; background:#333">
	<?php
	...
	<table width="440" border="0" cellspacing="0">
		<tr>
			<th width="1"></th>
			<th colspan="4">
				<div align="center" class="Estilo4d1">Reporte Semanal</div>
				<div align="right"></div>
			</th>
		</tr>
		<tr>
	...
	function clicktoolBar(id) {
		switch (id) {
			case "Cerrar_":
				...
				break;
			case "ImprimiR_":
				abrir('reportesemanalPV-2.php?desde=' + $("fc1").value + "&hasta=" + $("fc2").value + "&IDC=" + $('con').title, ' ', 1, 0, 0, 0, 0, 0, 1, 400, 400, 100, 100, 1);
				break;
			case "Imprimit_":
				abrir('reportesemanalPV-3.php?desde=' + $("fc1").value + "&hasta=" + $("fc2").value + "&IDC=" + $('con').title, ' ', 1, 0, 0, 0, 0, 0, 1, 400, 500, 100, 100, 1);
				break;

				//ImprimirReporte4('reportesemanal-2.php');
		}
	}
	dhxWins1 = new dhtmlXWindows();
	dhxWins1.setImagePath("codebase/imgs/");
	w1 = dhxWins1.createWindow("w1", 350, 270, 500, 150);
	w1.setText('Reporte Semanal (Punto de Venta) de ' + $('con').title);
